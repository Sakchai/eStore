...
namespace QNet.Services.Tests.Orders
{
    [TestFixture]
    public class OrderTotalCalculationServiceTests : ServiceTest
    {
        ...
        public void Can_get_shipping_total_with_fixed_shipping_rate_excluding_tax()
        {
            ...
            _genericAttributeService.Setup(x => x.GetAttribute<PickupPoint>(customer, QNetCustomerDefaults.SelectedPickupPointAttribute, _store.Id, null))
        ...
        public void Can_get_tax_total()
        {
            ...
            _genericAttributeService.Setup(x => x.GetAttribute<string>(customer, QNetCustomerDefaults.SelectedPaymentMethodAttribute, _store.Id, null))
                .Returns("test1");
        ...
        public void Can_get_shopping_cart_total_discount()
        {
            ...
            _genericAttributeService.Setup(x =>
                    x.GetAttribute<string>(customer, QNetCustomerDefaults.SelectedPaymentMethodAttribute, _store.Id, null))
                .Returns("test1");
