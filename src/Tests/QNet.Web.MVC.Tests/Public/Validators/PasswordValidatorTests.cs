...
namespace QNet.Web.MVC.Tests.Public.Validators
{
    [TestFixture]
    public class PasswordValidatorTests : BaseValidatorTests
    {
        ...
        public void Is_valid_tests_uppercase()
        {
            ...
            //ShouldNotHaveValidationError
            _validator.ShouldNotHaveValidationErrorFor(x => x.Password, _person.Password = "QNet");
        }
        ...
        public void Is_valid_tests_digit()
        {
            ...
            //ShouldNotHaveValidationError
            _validator.ShouldNotHaveValidationErrorFor(x => x.Password, _person.Password = "QNet1");
        }
        ...
        public void Is_valid_tests_all_rules()
        {
            ...
            _validator.ShouldHaveValidationErrorFor(x => x.Password, _person.Password = "QNet");
            _validator.ShouldHaveValidationErrorFor(x => x.Password, _person.Password = "nopcommerce123");
            _validator.ShouldHaveValidationErrorFor(x => x.Password, _person.Password = "QNet123");
            _validator.ShouldHaveValidationErrorFor(x => x.Password, _person.Password = "nopcommerce123$");
            _validator.ShouldHaveValidationErrorFor(x => x.Password, _person.Password = "NOPCOMMERCE123$");
            _validator.ShouldHaveValidationErrorFor(x => x.Password, _person.Password = "QNet123~");

            //ShouldNotHaveValidationError
            _validator.ShouldNotHaveValidationErrorFor(x => x.Password, _person.Password = "QNet123$");            
        }
