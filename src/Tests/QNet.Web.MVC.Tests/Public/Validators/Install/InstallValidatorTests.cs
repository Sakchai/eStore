...
using Moq;
using QNet.Web.Infrastructure.Installation;
using QNet.Web.Models.Install;
using QNet.Web.Validators.Install;
using NUnit.Framework;

namespace QNet.Web.MVC.Tests.Public.Validators.Install
{
    [TestFixture]
