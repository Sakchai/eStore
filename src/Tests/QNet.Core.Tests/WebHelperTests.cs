...
namespace QNet.Core.Tests
{
    ...
    public class WebHelperTests
    {
        ...
        private Mock<IQNetFileProvider> _fileProvider;
        ...
        public void SetUp()
        {
            ...
            _fileProvider = new Mock<IQNetFileProvider>();
        ...
        {
            _httpContext.Request.PathBase = "/QNetpath";
            _webHelper.GetStoreLocation(false).ShouldEqual("http://www.Example.com/QNetpath/");
        }
