...
namespace QNet.Core.Domain.Orders
{
    ...
    public class ShoppingCartSettings : ISettings
    {
        ...
        //When enabled it can cause one issue: https://www.qnet.net/boards/t/7679/vattax-rounding-error-important-fix.aspx
        //When disable it causes another one: https://www.qnet.net/boards/t/11419/nop-20-order-of-steps-in-checkout.aspx?p=3#46924
        /// <summary>
