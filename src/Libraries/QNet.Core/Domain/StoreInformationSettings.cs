...
namespace QNet.Core.Domain
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether "powered by QNet" text should be displayed.
        /// Please find more info at https://www.qnet.net/copyrightremoval.aspx
        /// </summary>
        public bool HidePoweredByQNetCommerce { get; set; }
