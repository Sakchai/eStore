...
namespace QNet.Core.Domain.Customers
{
    /// <summary>
    /// Customer extensions
    /// </summary>
    public static class CustomerExtensions
    {
        ...
        public static bool IsSearchEngineAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(QNetCustomerDefaults.SearchEngineCustomerName, StringComparison.InvariantCultureIgnoreCase);
            return result;
        }
        ...
        public static bool IsBackgroundTaskAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(QNetCustomerDefaults.BackgroundTaskCustomerName, StringComparison.InvariantCultureIgnoreCase);
            return result;
        }
        ...
        {
            return IsInCustomerRole(customer, QNetCustomerDefaults.AdministratorsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, QNetCustomerDefaults.ForumModeratorsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, QNetCustomerDefaults.RegisteredRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, QNetCustomerDefaults.GuestsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, QNetCustomerDefaults.VendorsRoleName, onlyActiveCustomerRoles);
        }
