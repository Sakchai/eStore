...
namespace QNet.Core.Domain.Common
{
    ...
    public class CommonSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether we should support previous QNet versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousQNetcommerceVersions { get; set; }
