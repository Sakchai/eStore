...
{
    /// <summary>
    /// Represents QNet engine
    /// </summary>
    public class QNetEngine : IEngine
    {
        #region Properties
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new QNetException("Unknown dependency");
                        return service;
                    });
            ...
            throw new QNetException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
