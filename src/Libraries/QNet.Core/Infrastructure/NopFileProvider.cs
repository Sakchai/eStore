...
namespace QNet.Core.Infrastructure
{
    ...
    /// </summary>
    public class QNetFileProvider : PhysicalFileProvider, IQNetFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a QNetFileProvider
        /// </summary>
        /// <param name="hostingEnvironment">Hosting environment</param>
        public QNetFileProvider(IHostingEnvironment hostingEnvironment)
