...
using QNet.Core.Html.CodeFormatter;
using QNet.Core.Infrastructure;

namespace QNet.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the URL tags: [url=https://www.QNet.com]my site[/url]
                // becomes: <a href="https://www.QNet.com">my site</a>
                text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

                // format the URL tags: [url]https://www.QNet.com[/url]
                // becomes: <a href="https://www.QNet.com">https://www.QNet.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]https://www.QNet.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="https://www.QNet.com/Content/Images/Image.jpg">
