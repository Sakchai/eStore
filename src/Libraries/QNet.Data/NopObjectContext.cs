...
namespace QNet.Data
{
    ...
    /// </summary>
    public partial class QNetObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public QNetObjectContext(DbContextOptions<QNetObjectContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var typeConfigurations = Assembly.GetExecutingAssembly().GetTypes().Where(type => 
                (type.BaseType?.IsGenericType ?? false) 
                    && (type.BaseType.GetGenericTypeDefinition() == typeof(QNetEntityTypeConfiguration<>) 
                        || type.BaseType.GetGenericTypeDefinition() == typeof(QNetQueryTypeConfiguration<>)));
