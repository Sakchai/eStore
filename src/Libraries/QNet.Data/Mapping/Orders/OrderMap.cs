...
namespace QNet.Data.Mapping.Orders
{
    ...
    /// </summary>
    public partial class OrderMap : QNetEntityTypeConfiguration<Order>
    {
        #region Methods
        ...
        public override void Configure(EntityTypeBuilder<Order> builder)
        {
            ...
            builder.Property(order => order.AllowStoringCreditCardNumber).HasColumnType("bit(1)");
            builder.Property(order => order.Deleted).HasColumnType("bit(1)");
            builder.Property(order => order.PickupInStore).HasColumnType("bit(1)");
