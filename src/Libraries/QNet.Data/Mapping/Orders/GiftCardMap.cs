...
namespace QNet.Data.Mapping.Orders
{
    ...
    /// </summary>
    public partial class GiftCardMap : QNetEntityTypeConfiguration<GiftCard>
    {
        #region Methods
        ...
        public override void Configure(EntityTypeBuilder<GiftCard> builder)
        {
            ...
            builder.Property(giftcard => giftcard.IsGiftCardActivated).HasColumnType("bit(1)");
            builder.Property(giftcard => giftcard.IsRecipientNotified).HasColumnType("bit(1)");
