...
namespace QNet.Data.Mapping.Discounts
{
    ...
    /// </summary>
    public partial class DiscountManufacturerMap : QNetEntityTypeConfiguration<DiscountManufacturerMapping>
    {
        #region Methods
        ...
        {
            builder.ToTable(QNetMappingDefaults.DiscountAppliedToManufacturersTable);
