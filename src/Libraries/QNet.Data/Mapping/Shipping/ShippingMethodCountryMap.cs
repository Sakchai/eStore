...
namespace QNet.Data.Mapping.Shipping
{
    ...
    /// </summary>
    public partial class ShippingMethodCountryMap : QNetEntityTypeConfiguration<ShippingMethodCountryMapping>
    {
        #region Methods
        ...
        {
            builder.ToTable(QNetMappingDefaults.ShippingMethodRestrictionsTable);
