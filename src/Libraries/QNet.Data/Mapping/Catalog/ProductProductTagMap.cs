...
namespace QNet.Data.Mapping.Catalog
{
    ...
    /// </summary>
    public partial class ProductProductTagMap : QNetEntityTypeConfiguration<ProductProductTagMapping>
    {
        #region Methods
        ...
        {
            builder.ToTable(QNetMappingDefaults.ProductProductTagTable);
