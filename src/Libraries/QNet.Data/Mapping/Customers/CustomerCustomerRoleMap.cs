...
namespace QNet.Data.Mapping.Customers
{
    ...
    /// </summary>
    public partial class CustomerCustomerRoleMap : QNetEntityTypeConfiguration<CustomerCustomerRoleMapping>
    {
        #region Methods
        ...
        {
            builder.ToTable(QNetMappingDefaults.CustomerCustomerRoleTable);
