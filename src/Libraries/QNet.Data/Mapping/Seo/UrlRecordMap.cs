...
namespace QNet.Data.Mapping.Seo
{
    /// <summary>
    /// Represents an URL record mapping configuration
    /// </summary>
    public partial class UrlRecordMap : QNetEntityTypeConfiguration<UrlRecord>
    {
        #region Methods
        ...
        public override void Configure(EntityTypeBuilder<UrlRecord> builder)
        {
            ...
            builder.Property(urlrecord => urlrecord.IsActive).HasColumnType("bit(1)");
