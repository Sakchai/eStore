...
namespace QNet.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        public virtual void DeleteCountry(Country country)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetDirectoryDefaults.CountriesPrefixCacheKey);
        ...
        {
            var key = string.Format(QNetDirectoryDefaults.CountriesAllCacheKey, languageId, showHidden);
        ...
        public virtual Country GetCountryById(int countryId)
        {
            ...
            var key = string.Format(QNetDirectoryDefaults.CountriesByIdCacheKey, countryId);
        ...
        public virtual Country GetCountryByTwoLetterIsoCode(string twoLetterIsoCode)
        {
            ...
            var key = string.Format(QNetDirectoryDefaults.CountriesByTwoLetterCodeCacheKey, twoLetterIsoCode);
            return _cacheManager.Get(key, () =>
            {
                var query = from c in _countryRepository.Table
        ...
        public virtual Country GetCountryByThreeLetterIsoCode(string threeLetterIsoCode)
        {
            ...
            var key = string.Format(QNetDirectoryDefaults.CountriesByThreeLetterCodeCacheKey, threeLetterIsoCode);
            return _cacheManager.Get(key, () =>
            {
                var query = from c in _countryRepository.Table
