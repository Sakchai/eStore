...
namespace QNet.Services.Directory
{
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        public virtual void DeleteStateProvince(StateProvince stateProvince)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetDirectoryDefaults.StateProvincesPrefixCacheKey);
        ...
        public virtual StateProvince GetStateProvinceByAbbreviation(string abbreviation, int? countryId = null)
        {
            ...
            var key = string.Format(QNetDirectoryDefaults.StateProvincesByAbbreviationCacheKey, abbreviation, countryId.HasValue ? countryId.Value : 0);
        ...
        {
            var key = string.Format(QNetDirectoryDefaults.StateProvincesAllCacheKey, countryId, languageId, showHidden);
            return _cacheManager.Get(key, () =>
            {
