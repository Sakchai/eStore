...
namespace QNet.Services.Directory
{
    ...
    public partial class MeasureService : IMeasureService
    {
        ...
        public virtual void DeleteMeasureDimension(MeasureDimension measureDimension)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetDirectoryDefaults.MeasureDimensionsPrefixCacheKey);
        ...
        public virtual MeasureDimension GetMeasureDimensionById(int measureDimensionId)
        {
            ...
            var key = string.Format(QNetDirectoryDefaults.MeasureDimensionsByIdCacheKey, measureDimensionId);
        ...
        {
            return _cacheManager.Get(QNetDirectoryDefaults.MeasureDimensionsAllCacheKey, () =>
            {
            ...
            MeasureDimension sourceMeasureDimension)
        {
            ...
            if (exchangeRatio == decimal.Zero)
                throw new QNetException($"Exchange ratio not set for dimension [{sourceMeasureDimension.Name}]");
            ...
            MeasureDimension targetMeasureDimension)
        {
            ...
            if (exchangeRatio == decimal.Zero)
                throw new QNetException($"Exchange ratio not set for dimension [{targetMeasureDimension.Name}]");
            result = result * exchangeRatio;
        ...
        public virtual void DeleteMeasureWeight(MeasureWeight measureWeight)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetDirectoryDefaults.MeasureWeightsPrefixCacheKey);
        ...
        public virtual MeasureWeight GetMeasureWeightById(int measureWeightId)
        {
            ...
            var key = string.Format(QNetDirectoryDefaults.MeasureWeightsByIdCacheKey, measureWeightId);
        ...
        {
            return _cacheManager.Get(QNetDirectoryDefaults.MeasureWeightsAllCacheKey, () =>
            {
        ...
        public virtual decimal ConvertToPrimaryMeasureWeight(decimal value, MeasureWeight sourceMeasureWeight)
        {
            ...
            if (exchangeRatio == decimal.Zero)
                throw new QNetException($"Exchange ratio not set for weight [{sourceMeasureWeight.Name}]");
            result = result / exchangeRatio;
            ...
            MeasureWeight targetMeasureWeight)
        {
            ...
            if (exchangeRatio == decimal.Zero)
                throw new QNetException($"Exchange ratio not set for weight [{targetMeasureWeight.Name}]");
            result = result * exchangeRatio;
