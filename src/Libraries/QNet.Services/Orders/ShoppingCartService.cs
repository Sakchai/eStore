    ...
    public partial class ShoppingCartService : IShoppingCartService
    {
            ...
            bool ensureOnlyActiveCheckoutAttributes = false)
        {
                ...
                shoppingCartItem.ShoppingCartType == ShoppingCartType.ShoppingCart)
            {
                ...
                var checkoutAttributesXml = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.CheckoutAttributes, storeId);
                checkoutAttributesXml = _checkoutAttributeParser.EnsureOnlyActiveAttributes(checkoutAttributesXml, cart);
                _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.CheckoutAttributes, checkoutAttributesXml, storeId);
            }
        ...
        public virtual void MigrateShoppingCart(Customer fromCustomer, Customer toCustomer, bool includeCouponCodes)
        {
            ...
            var checkoutAttributesXml = _genericAttributeService.GetAttribute<string>(fromCustomer, QNetCustomerDefaults.CheckoutAttributes, _storeContext.CurrentStore.Id);
            _genericAttributeService.SaveAttribute(toCustomer, QNetCustomerDefaults.CheckoutAttributes, checkoutAttributesXml, _storeContext.CurrentStore.Id);
        }
            ...
            out int cycleLength, out RecurringProductCyclePeriod cyclePeriod, out int totalCycles)
        {
            ...
            foreach (var sci in shoppingCart)
            {
                ...
                if (product == null)
                {
                    throw new QNetException($"Product (Id={sci.ProductId}) cannot be loaded");
                }
