...
namespace QNet.Services.Orders
{
    ...
    public partial class CheckoutAttributeService : ICheckoutAttributeService
    {
        ...
        public virtual void DeleteCheckoutAttribute(CheckoutAttribute checkoutAttribute)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetOrderDefaults.CheckoutAttributesPrefixCacheKey);
            _cacheManager.RemoveByPrefix(QNetOrderDefaults.CheckoutAttributeValuesPrefixCacheKey);
        ...
        {
            var key = string.Format(QNetOrderDefaults.CheckoutAttributesAllCacheKey, storeId, excludeShippableAttributes);
        ...
        public virtual CheckoutAttribute GetCheckoutAttributeById(int checkoutAttributeId)
        {
            ...
            var key = string.Format(QNetOrderDefaults.CheckoutAttributesByIdCacheKey, checkoutAttributeId);
        ...
        {
            var key = string.Format(QNetOrderDefaults.CheckoutAttributeValuesAllCacheKey, checkoutAttributeId);
            return _cacheManager.Get(key, () =>
            {
        ...
        public virtual CheckoutAttributeValue GetCheckoutAttributeValueById(int checkoutAttributeValueId)
        {
            ...
            var key = string.Format(QNetOrderDefaults.CheckoutAttributeValuesByIdCacheKey, checkoutAttributeValueId);
