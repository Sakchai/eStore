...
namespace QNet.Services.Common
{
    ...
    public partial class AddressAttributeService : IAddressAttributeService
    {
        ...
        public virtual void DeleteAddressAttribute(AddressAttribute addressAttribute)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetCommonDefaults.AddressAttributesPrefixCacheKey);
            _cacheManager.RemoveByPrefix(QNetCommonDefaults.AddressAttributeValuesPrefixCacheKey);
        ...
        {
            return _cacheManager.Get(QNetCommonDefaults.AddressAttributesAllCacheKey, () =>
            {
        ...
        public virtual AddressAttribute GetAddressAttributeById(int addressAttributeId)
        {
            ...
            var key = string.Format(QNetCommonDefaults.AddressAttributesByIdCacheKey, addressAttributeId);
        ...
        {
            var key = string.Format(QNetCommonDefaults.AddressAttributeValuesAllCacheKey, addressAttributeId);
        ...
        public virtual AddressAttributeValue GetAddressAttributeValueById(int addressAttributeValueId)
        {
            ...
            var key = string.Format(QNetCommonDefaults.AddressAttributeValuesByIdCacheKey, addressAttributeValueId);
