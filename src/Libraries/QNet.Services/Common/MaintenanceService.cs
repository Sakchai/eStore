...
namespace QNet.Services.Common
{
    ...
    public partial class MaintenanceService : IMaintenanceService
    {
        ...
        {
            var path = _fileProvider.GetAbsolutePath(QNetCommonDefaults.DbBackupsPath);
        ...
        public virtual IList<string> GetAllBackupFiles()
        {
            ...
            {
                throw new QNetException("Backup directory not exists");
            }

            return _fileProvider.GetFiles(path, $"*.{QNetCommonDefaults.DbBackupFileExtension}")
        ...
        public virtual void BackupDatabase()
        {
            ...
            var fileName = _fileProvider.Combine(GetBackupDirectoryPath(), $"database_{DateTime.Now:yyyy-MM-dd-HH-mm-ss}_{CommonHelper.GenerateRandomDigitCode(10)}.{QNetCommonDefaults.DbBackupFileExtension}");
