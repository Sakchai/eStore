...
{
    /// <summary>
    /// Represents the HTTP client to request QNet official site
    /// </summary>
    public partial class QNetHttpClient
    {
        #region Fields
        ...
        public QNetHttpClient(AdminAreaSettings adminAreaSettings,
            HttpClient client,
        ...
        {
            //configure client
            client.BaseAddress = new Uri("https://www.qnet.net/");
        ...
        public virtual async Task<string> GetCopyrightWarningAsync()
        {
            ...
            var url = string.Format(QNetCommonDefaults.QNetCopyrightWarningPath,
        ...
        {
            //prepare URL to request
            var url = string.Format(QNetCommonDefaults.QNetNewsRssPath,
                QNetVersion.CurrentVersion,
                _webHelper.IsLocalRequest(_httpContextAccessor.HttpContext.Request),
        ...
        {
            //prepare URL to request
            var url = QNetCommonDefaults.QNetExtensionsCategoriesPath.ToLowerInvariant();
        ...
        {
            //prepare URL to request
            var url = QNetCommonDefaults.QNetExtensionsVersionsPath.ToLowerInvariant();
        ...
        {
            //prepare URL to request
            var url = string.Format(QNetCommonDefaults.QNetExtensionsPath,
