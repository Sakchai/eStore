...
namespace QNet.Services.Common
{
    ...
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        public virtual void DeleteAttribute(GenericAttribute attribute)
        {
            ...
            //cache
            _cacheManager.RemoveByPrefix(QNetCommonDefaults.GenericAttributePrefixCacheKey);
        ...
        {
            var key = string.Format(QNetCommonDefaults.GenericAttributeCacheKey, entityId, keyGroup);
