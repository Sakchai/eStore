...
namespace QNet.Services.Themes
{
    /// <summary>
    ...
    public partial class ThemeProvider : IThemeProvider
    {
        ...
        public ThemeProvider(IQNetFileProvider fileProvider)
        {
        ...
        public IList<ThemeDescriptor> GetThemes()
        {
            ...
            var themeDirectoryPath = _fileProvider.MapPath(QNetPluginDefaults.ThemesPath);
            foreach (var descriptionFile in _fileProvider.GetFiles(themeDirectoryPath, QNetPluginDefaults.ThemeDescriptionFileName, false))
            {
