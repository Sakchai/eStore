...
namespace QNet.Services.Forums
{
    ...
    public partial class ForumService : IForumService
    {
        ...
        private void UpdateCustomerStats(int customerId)
        {
            ...
            _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.ForumPostCountAttribute, numPosts);
        }
        ...
        public virtual void DeleteForumGroup(ForumGroup forumGroup)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetForumDefaults.ForumGroupPrefixCacheKey);
            _cacheManager.RemoveByPrefix(QNetForumDefaults.ForumPrefixCacheKey);
        ...
        {
            return _cacheManager.Get(QNetForumDefaults.ForumGroupAllCacheKey, () =>
            {
        ...
        {
            var key = string.Format(QNetForumDefaults.ForumAllByForumGroupIdCacheKey, forumGroupId);
        ...
        public virtual void InsertPrivateMessage(PrivateMessage privateMessage)
        {
            ...
            if (customerTo == null)
            {
                throw new QNetException("Recipient could not be loaded");
            }

            //UI notification
            _genericAttributeService.SaveAttribute(customerTo, QNetCustomerDefaults.NotifiedAboutNewPrivateMessagesAttribute, false, privateMessage.StoreId);
        ...
        public virtual string GetTopicSeName(ForumTopic forumTopic)
        {
            ...
            var maxLength = QNetSeoDefaults.ForumTopicLength;
