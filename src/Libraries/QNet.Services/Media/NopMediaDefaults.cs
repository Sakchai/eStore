namespace QNet.Services.Media
{
    ...
    /// </summary>
    public static partial class QNetMediaDefaults
    {
        /// <summary>
        ...
        /// {0} : thumb file name
        /// </remarks>
        public static string ThumbExistsCacheKey => "QNet.azure.thumb.exists-{0}";

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string ThumbsPrefixCacheKey => "QNet.azure.thumb";
