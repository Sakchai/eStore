...
namespace QNet.Services.Localization
{
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        {
            var key = string.Format(QNetLocalizationDefaults.LocaleStringResourcesAllCacheKey, languageId);
            ...
            if (!loadPublicLocales.HasValue || _cacheManager.IsSet(key))
            {
                ...
                _cacheManager.Remove(string.Format(QNetLocalizationDefaults.LocaleStringResourcesAllPublicCacheKey, languageId));
                _cacheManager.Remove(string.Format(QNetLocalizationDefaults.LocaleStringResourcesAllAdminCacheKey, languageId));

                return rez;
            }

            //performance optimization of the site startup
            key = string.Format(loadPublicLocales.Value ? QNetLocalizationDefaults.LocaleStringResourcesAllPublicCacheKey : QNetLocalizationDefaults.LocaleStringResourcesAllAdminCacheKey, languageId);
            ...
            return _cacheManager.Get(key, () =>
            {
                ...
                var query = from l in _lsrRepository.TableNoTracking
                            ...
                            where l.LanguageId == languageId
                            select l;
                query = loadPublicLocales.Value ? query.Where(r => !r.ResourceName.StartsWith(QNetLocalizationDefaults.AdminLocaleStringResourcesPrefix)) : query.Where(r => r.ResourceName.StartsWith(QNetLocalizationDefaults.AdminLocaleStringResourcesPrefix));
                return ResourceValuesToDictionary(query);
            });
        }
            ...
            bool logIfNotFound = true, string defaultValue = "", bool returnEmptyIfNotFound = false)
        {
            ...
            if (_localizationSettings.LoadAllLocaleRecordsOnStartup)
            {
                ...
                var resources = GetAllResourceValues(languageId, !resourceKey.StartsWith(QNetLocalizationDefaults.AdminLocaleStringResourcesPrefix, StringComparison.InvariantCultureIgnoreCase));
            ...
            {
                //gradual loading
                var key = string.Format(QNetLocalizationDefaults.LocaleStringResourcesByResourceNameCacheKey, languageId, resourceKey);
        ...
        public virtual string ExportResourcesToXml(Language language)
        {
            ...
            using (var stream = new MemoryStream())
            {
                using (var xmlWriter = new XmlTextWriter(stream, Encoding.UTF8))
                {
                    ...
                    xmlWriter.WriteAttributeString("SupportedVersion", QNetVersion.CurrentVersion);
        ...
        public virtual string GetLocalizedEnum<TEnum>(TEnum enumValue, int? languageId = null) where TEnum : struct
        {
            ...
            //localized value
            var resourceName = $"{QNetLocalizationDefaults.EnumLocaleStringResourcesPrefix}{typeof(TEnum)}.{enumValue}";
        ...
        public virtual string GetLocalizedPermissionName(PermissionRecord permissionRecord, int? languageId = null)
        {
            ...
            //localized value
            var resourceName = $"{QNetLocalizationDefaults.PermissionLocaleStringResourcesPrefix}{permissionRecord.SystemName}";
            var result = GetResource(resourceName, languageId ?? _workContext.WorkingLanguage.Id, false, string.Empty, true);
            ...
            where TPlugin : IPlugin
        {
            ...
            //localized value
            var resourceName = $"{QNetLocalizationDefaults.PluginNameLocaleStringResourcesPrefix}{systemName}";
