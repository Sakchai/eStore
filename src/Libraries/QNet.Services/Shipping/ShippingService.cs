...
using QNet.Services.Shipping.Pickup;
...
namespace QNet.Services.Shipping
{
    ...
    public partial class ShippingService : IShippingService
    {
        ...
        public virtual void DeleteShippingMethod(ShippingMethod shippingMethod)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetShippingDefaults.ShippingMethodsPrefixCacheKey);
        ...
        {
            var key = string.Format(QNetShippingDefaults.ShippingMethodsAllCacheKey, filterByCountryId ?? 0);
        ...
        public virtual void DeleteWarehouse(Warehouse warehouse)
        {
            ...
            //clear cache
            _cacheManager.RemoveByPrefix(QNetShippingDefaults.WarehousesPrefixCacheKey);
        ...
        public virtual Warehouse GetWarehouseById(int warehouseId)
        {
            ...
            var key = string.Format(QNetShippingDefaults.WarehousesByIdCacheKey, warehouseId);
            ...
            bool includeCheckoutAttributes = true, bool ignoreFreeShippedItems = false)
        {
            ...
            if (request.Customer == null || !includeCheckoutAttributes)
                return totalWeight;
            var checkoutAttributesXml = _genericAttributeService.GetAttribute<string>(request.Customer, QNetCustomerDefaults.CheckoutAttributes, _storeContext.CurrentStore.Id);
