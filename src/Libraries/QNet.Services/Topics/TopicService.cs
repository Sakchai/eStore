...
namespace QNet.Services.Topics
{
    ...
    public partial class TopicService : ITopicService
    {
        ...
        public virtual void DeleteTopic(Topic topic)
        {
            ...
            //cache
            _cacheManager.RemoveByPrefix(QNetTopicDefaults.TopicsPrefixCacheKey);
        ...
        public virtual Topic GetTopicById(int topicId)
        {
            ...
            var key = string.Format(QNetTopicDefaults.TopicsByIdCacheKey, topicId);
        ...
        {
            var key = string.Format(QNetTopicDefaults.TopicsAllCacheKey, storeId, ignorAcl, showHidden);
