...
namespace QNet.Services.Security
{
    ...
    public partial class AclService : IAclService
    {
        ...
        public virtual void DeleteAclRecord(AclRecord aclRecord)
        {
            ...
            //cache
            _cacheManager.RemoveByPrefix(QNetSecurityDefaults.AclRecordPrefixCacheKey);
        ...
        public virtual int[] GetCustomerRoleIdsWithAccess<T>(T entity) where T : BaseEntity, IAclSupported
        {
            ...
            var key = string.Format(QNetSecurityDefaults.AclRecordByEntityIdNameCacheKey, entityId, entityName);
