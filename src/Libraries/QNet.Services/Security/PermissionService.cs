...
namespace QNet.Services.Security
{
    ...
    public partial class PermissionService : IPermissionService
    {
        ...
        {
            var key = string.Format(QNetSecurityDefaults.PermissionsAllByCustomerRoleIdCacheKey, customerRoleId);
        ...
        protected virtual bool Authorize(string permissionRecordSystemName, int customerRoleId)
        {
            ...
            var key = string.Format(QNetSecurityDefaults.PermissionsAllowedCacheKey, customerRoleId, permissionRecordSystemName);
        ...
        public virtual void DeletePermissionRecord(PermissionRecord permission)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetSecurityDefaults.PermissionsPrefixCacheKey);
            _staticCacheManager.RemoveByPrefix(QNetSecurityDefaults.PermissionsPrefixCacheKey);
        }
