namespace QNet.Services.Security
{
    /// <summary>
    /// Represents default values related to security services
    /// </summary>
    public static partial class QNetSecurityDefaults
    {
        ...
        /// {1} : entity name
        /// </remarks>
        public static string AclRecordByEntityIdNameCacheKey => "QNet.aclrecord.entityid-name-{0}-{1}";

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string AclRecordPrefixCacheKey => "QNet.aclrecord.";
        ...
        /// </remarks>
        public static string PermissionsAllowedCacheKey => "QNet.permission.allowed-{0}-{1}";
        ...
        /// {0} : customer role ID
        /// </remarks>
        public static string PermissionsAllByCustomerRoleIdCacheKey => "QNet.permission.allbycustomerroleid-{0}";

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string PermissionsPrefixCacheKey => "QNet.permission.";
