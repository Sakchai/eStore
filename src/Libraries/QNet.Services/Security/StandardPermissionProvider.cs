    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public virtual IEnumerable<DefaultPermissionRecord> GetDefaultPermissions()
        {
            return new[] 
            {
                ...
                {
                    CustomerRoleSystemName = QNetCustomerDefaults.AdministratorsRoleName,
                ...
                new DefaultPermissionRecord 
                {
                    CustomerRoleSystemName = QNetCustomerDefaults.ForumModeratorsRoleName,
                    PermissionRecords = new[] 
                    {
                        DisplayPrices,
                        EnableShoppingCart,
                ...
                new DefaultPermissionRecord 
                {
                    CustomerRoleSystemName = QNetCustomerDefaults.GuestsRoleName,
                    PermissionRecords = new[] 
                    {
                        DisplayPrices,
                        EnableShoppingCart,
                ...
                new DefaultPermissionRecord 
                {
                    CustomerRoleSystemName = QNetCustomerDefaults.RegisteredRoleName,
                    PermissionRecords = new[] 
                    {
                        DisplayPrices,
                        EnableShoppingCart,
                ...
                new DefaultPermissionRecord 
                {
                    CustomerRoleSystemName = QNetCustomerDefaults.VendorsRoleName,
                    PermissionRecords = new[] 
                    {
                        AccessAdminPanel,
                        ManageProducts,
