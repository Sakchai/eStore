...
namespace QNet.Services.Tax
{
    ...
    public partial class TaxCategoryService : ITaxCategoryService
    {
        ...
        public virtual void DeleteTaxCategory(TaxCategory taxCategory)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetTaxDefaults.TaxCategoriesPrefixCacheKey);
        ...
        {
            return _cacheManager.Get(QNetTaxDefaults.TaxCategoriesAllCacheKey, () =>
            {
        ...
        public virtual TaxCategory GetTaxCategoryById(int taxCategoryId)
        {
            ...
            var key = string.Format(QNetTaxDefaults.TaxCategoriesByIdCacheKey, taxCategoryId);
