...
namespace QNet.Services.Tax
{
    ...
    public partial class TaxService : ITaxService
    {
        ...
        protected virtual bool IsEuConsumer(Customer customer)
        {
            ...
            var customerVatStatus = (VatNumberStatus)_genericAttributeService.GetAttribute<int>(customer, QNetCustomerDefaults.VatNumberStatusIdAttribute);
        ...
        protected virtual CalculateTaxRequest.TaxAddress LoadDefaultTaxAddress()
        {
            ...
            var cacheKey = string.Format(QNetTaxDefaults.TaxAddressByAddressIdCacheKey, addressId);
