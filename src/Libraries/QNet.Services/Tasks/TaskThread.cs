...
namespace QNet.Services.Tasks
{
    ...
    public partial class TaskThread : IDisposable
    {
        ...
        static TaskThread()
        {
            _scheduleTaskUrl = $"{EngineContext.Current.Resolve<IStoreContext>().CurrentStore.Url}{QNetTaskDefaults.ScheduleTaskPath}";
        ...
        private void Run()
        {
            ...
            foreach (var taskName in _tasks.Keys)
            {
                ...
                try
                {
                    ...
                    var client = EngineContext.Current.Resolve<IHttpClientFactory>().CreateClient(QNetHttpDefaults.DefaultHttpClient);
