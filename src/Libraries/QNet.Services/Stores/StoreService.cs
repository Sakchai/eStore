...
namespace QNet.Services.Stores
{
    ...
    public partial class StoreService : IStoreService
    {
        ...
        public virtual void DeleteStore(Store store)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetStoreDefaults.StoresPrefixCacheKey);
        ...
        public virtual IList<Store> GetAllStores(bool loadCacheableCopy = true)
        {
            ...
            {
                //cacheable copy
                return _cacheManager.Get(QNetStoreDefaults.StoresAllCacheKey, () =>
                {
        ...
        public virtual Store GetStoreById(int storeId, bool loadCacheableCopy = true)
        {
            ...
            //cacheable copy
            var key = string.Format(QNetStoreDefaults.StoresByIdCacheKey, storeId);
