...
namespace QNet.Services.Plugins
{
    ...
    /// </summary>
    public static partial class QNetPluginDefaults
    {
        /// <summary>
        ...
        /// </remarks>
        public static string AdminNavigationPluginsCacheKey => "QNet.plugins.adminnavigation-{0}";

        /// <summary>
        /// Gets a key to clear cache
        /// </summary>
        public static string AdminNavigationPluginsPrefixCacheKey => "QNet.plugins.adminnavigation";
    }
}