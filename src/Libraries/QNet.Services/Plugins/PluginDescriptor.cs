...
namespace QNet.Services.Plugins
{
    ...
    public partial class PluginDescriptor : IDescriptor, IComparable<PluginDescriptor>
    {
        ...
        public virtual void Save()
        {
            ...
            var filePath = fileProvider.Combine(fileProvider.GetDirectoryName(OriginalAssemblyFile), QNetPluginDefaults.DescriptionFileName);
        ...
        public static PluginDescriptor GetPluginDescriptorFromText(string text)
        {
            ...
            //QNet 2.00 didn't have 'SupportedVersions' parameter, so let's set it to "2.00"
        ...
        /// <summary>
        /// Gets or sets the supported versions of QNet
        /// </summary>
