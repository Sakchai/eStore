...
namespace QNet.Services.Messages
{
    ...
    public partial class NotificationService : INotificationService
    {
        ...
        protected virtual void PrepareTempData(NotifyType type, string message, bool encode = true)
        {
            ...
            var messages = tempData.ContainsKey(QNetMessageDefaults.NotificationListKey)
                ? JsonConvert.DeserializeObject<IList<NotifyData>>(tempData[QNetMessageDefaults.NotificationListKey].ToString())
                : new List<NotifyData>();
            ...
            tempData[QNetMessageDefaults.NotificationListKey] = JsonConvert.SerializeObject(messages);
        }
