...
namespace QNet.Services.Messages
{
    ...
    public partial class MessageTemplateService : IMessageTemplateService
    {
        ...
        public virtual void DeleteMessageTemplate(MessageTemplate messageTemplate)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetMessageDefaults.MessageTemplatesPrefixCacheKey);
        ...
        public virtual IList<MessageTemplate> GetMessageTemplatesByName(string messageTemplateName, int? storeId = null)
        {
            ...
            var key = string.Format(QNetMessageDefaults.MessageTemplatesByNameCacheKey, messageTemplateName, storeId ?? 0);
        ...
        {
            var key = string.Format(QNetMessageDefaults.MessageTemplatesAllCacheKey, storeId);
            return _cacheManager.Get(key, () =>
            {
