...
namespace QNet.Services.Catalog
{
    ...
    public partial class ProductTagService : IProductTagService
    {
        ...
        private Dictionary<int, int> GetProductCount(int storeId, bool showHidden)
        {
            ...
            var key = string.Format(QNetCatalogDefaults.ProductTagCountCacheKey, storeId, allowedCustomerRolesIds, showHidden);
        ...
        {
            var key = string.Format(QNetCatalogDefaults.ProductTagAllByProductIdCacheKey, productId);
