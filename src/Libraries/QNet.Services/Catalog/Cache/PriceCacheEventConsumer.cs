...
namespace QNet.Services.Catalog.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeletedEvent<Order>>
    {
        ...
        {
            _cacheManager.RemoveByPrefix(QNetCatalogDefaults.ProductPricePrefixCacheKey);
            _cacheManager.RemoveByPrefix(QNetCatalogDefaults.ProductCategoryIdsPrefixCacheKey);
            _cacheManager.RemoveByPrefix(QNetCatalogDefaults.ProductManufacturerIdsPrefixCacheKey);
        }
