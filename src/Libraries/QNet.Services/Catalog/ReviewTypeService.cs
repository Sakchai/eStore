...
namespace QNet.Services.Catalog
{
    ...
    public partial class ReviewTypeService : IReviewTypeService
    {
        ...
        {
            return _cacheManager.Get(QNetCatalogDefaults.ReviewTypeAllKey, () =>
            {
        ...
        public virtual ReviewType GetReviewTypeById(int reviewTypeId)
        {
            ...
            var key = string.Format(QNetCatalogDefaults.ReviewTypeByIdKey, reviewTypeId);
        ...
        public virtual void InsertReviewType(ReviewType reviewType)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetCatalogDefaults.ReviewTypeByPrefixCacheKey);
        ...
        {
            var key = string.Format(QNetCatalogDefaults.ProductReviewReviewTypeMappingAllKey, productReviewId);
