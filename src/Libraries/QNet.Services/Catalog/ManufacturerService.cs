...
namespace QNet.Services.Catalog
{
    ...
    public partial class ManufacturerService : IManufacturerService
    {
        ...
        public virtual Manufacturer GetManufacturerById(int manufacturerId)
        {
            ...
            var key = string.Format(QNetCatalogDefaults.ManufacturersByIdCacheKey, manufacturerId);
        ...
        public virtual void InsertManufacturer(Manufacturer manufacturer)
        {
            ...
            //cache
            _cacheManager.RemoveByPrefix(QNetCatalogDefaults.ManufacturersPrefixCacheKey);
            _cacheManager.RemoveByPrefix(QNetCatalogDefaults.ProductManufacturersPrefixCacheKey);
            ...
            int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
        {
            ...
            var key = string.Format(QNetCatalogDefaults.ProductManufacturersAllByManufacturerIdCacheKey, showHidden, manufacturerId, pageIndex, pageSize, _workContext.CurrentCustomer.Id, _storeContext.CurrentStore.Id);
        ...
        public virtual IList<ProductManufacturer> GetProductManufacturersByProductId(int productId, bool showHidden = false)
        {
            ...
            var key = string.Format(QNetCatalogDefaults.ProductManufacturersAllByProductIdCacheKey, showHidden, productId, _workContext.CurrentCustomer.Id, _storeContext.CurrentStore.Id);
            return _cacheManager.Get(key, () =>
            {
                var query = from pm in _productManufacturerRepository.Table
                            join m in _manufacturerRepository.Table on pm.ManufacturerId equals m.Id
