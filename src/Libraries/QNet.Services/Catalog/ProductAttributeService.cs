...
namespace QNet.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        {
            var key = string.Format(QNetCatalogDefaults.ProductAttributesAllCacheKey, pageIndex, pageSize);
        ...
        public virtual ProductAttribute GetProductAttributeById(int productAttributeId)
        {
            ...
            var key = string.Format(QNetCatalogDefaults.ProductAttributesByIdCacheKey, productAttributeId);
        ...
        public virtual IList<ProductAttributeMapping> GetProductAttributeMappingsByProductId(int productId)
        {
            ...
            {
                var allCacheKey = string.Format(QNetCatalogDefaults.ProductAttributeMappingsAllCacheKey, productId);
            ...
            var hasAttributesCacheKey = string.Format(QNetCatalogDefaults.ProductHasProductAttributesCacheKey, productId);
        ...
        public virtual ProductAttributeMapping GetProductAttributeMappingById(int productAttributeMappingId)
        {
            ...
            var key = string.Format(QNetCatalogDefaults.ProductAttributeMappingsByIdCacheKey, productAttributeMappingId);
        ...
        {
            var key = string.Format(QNetCatalogDefaults.ProductAttributeValuesAllCacheKey, productAttributeMappingId);
            return _cacheManager.Get(key, () =>
            {
        ...
        public virtual ProductAttributeValue GetProductAttributeValueById(int productAttributeValueId)
        {
            ...
            var key = string.Format(QNetCatalogDefaults.ProductAttributeValuesByIdCacheKey, productAttributeValueId);
        ...
        public virtual IList<ProductAttributeCombination> GetAllProductAttributeCombinations(int productId)
        {
            ...
            var key = string.Format(QNetCatalogDefaults.ProductAttributeCombinationsAllCacheKey, productId);
