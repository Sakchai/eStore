...
namespace QNet.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        public virtual IList<Category> GetAllCategories(int storeId = 0, bool showHidden = false, bool loadCacheableCopy = true)
        {
            ...
            {
                //cacheable copy
                var key = string.Format(QNetCatalogDefaults.CategoriesAllCacheKey,
                    storeId,
        ...
        {
            var key = string.Format(QNetCatalogDefaults.CategoriesByParentCategoryIdCacheKey, parentCategoryId, showHidden, _workContext.CurrentCustomer.Id, _storeContext.CurrentStore.Id);
        ...
        {
            var cacheKey = string.Format(QNetCatalogDefaults.CategoriesChildIdentifiersCacheKey,
                parentCategoryId,
                string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
        ...
        public virtual Category GetCategoryById(int categoryId)
        {
            ...
            var key = string.Format(QNetCatalogDefaults.CategoriesByIdCacheKey, categoryId);
        ...
        public virtual void InsertCategory(Category category)
        {
            ...
            //cache
            _cacheManager.RemoveByPrefix(QNetCatalogDefaults.CategoriesPrefixCacheKey);
            _staticCacheManager.RemoveByPrefix(QNetCatalogDefaults.CategoriesPrefixCacheKey);
            _cacheManager.RemoveByPrefix(QNetCatalogDefaults.ProductCategoriesPrefixCacheKey);
            ...
            int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
        {
            ...
            var key = string.Format(QNetCatalogDefaults.ProductCategoriesAllByCategoryIdCacheKey, showHidden, categoryId, pageIndex, pageSize, _workContext.CurrentCustomer.Id, _storeContext.CurrentStore.Id);
            return _cacheManager.Get(key, () =>
            {
        ...
        public virtual IList<ProductCategory> GetProductCategoriesByProductId(int productId, int storeId, bool showHidden = false)
        {
            ...
            var key = string.Format(QNetCatalogDefaults.ProductCategoriesAllByProductIdCacheKey, showHidden, productId, _workContext.CurrentCustomer.Id, storeId);
            return _cacheManager.Get(key, () =>
            {
                var query = from pc in _productCategoryRepository.Table
                            join c in _categoryRepository.Table on pc.CategoryId equals c.Id
