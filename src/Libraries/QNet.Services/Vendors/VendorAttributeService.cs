...
namespace QNet.Services.Vendors
{
    ...
    public partial class VendorAttributeService : IVendorAttributeService
    {
        ...
        {
            return _cacheManager.Get(QNetVendorsServiceDefaults.VendorAttributesAllCacheKey, () =>
            {
        ...
        public virtual VendorAttribute GetVendorAttributeById(int vendorAttributeId)
        {
            ...
            var key = string.Format(QNetVendorsServiceDefaults.VendorAttributesByIdCacheKey, vendorAttributeId);
        ...
        {
            var key = string.Format(QNetVendorsServiceDefaults.VendorAttributeValuesAllCacheKey, vendorAttributeId);
        ...
        public virtual VendorAttributeValue GetVendorAttributeValueById(int vendorAttributeValueId)
        {
            ...
            var key = string.Format(QNetVendorsServiceDefaults.VendorAttributeValuesByIdCacheKey, vendorAttributeValueId);
