...
namespace QNet.Services.Customers
{
    ...
    public partial class CustomerAttributeService : ICustomerAttributeService
    {
        ...
        public virtual void DeleteCustomerAttribute(CustomerAttribute customerAttribute)
        {
            ...
            _cacheManager.RemoveByPrefix(QNetCustomerServiceDefaults.CustomerAttributesPrefixCacheKey);
            _cacheManager.RemoveByPrefix(QNetCustomerServiceDefaults.CustomerAttributeValuesPrefixCacheKey);
        ...
        {
            return _cacheManager.Get(QNetCustomerServiceDefaults.CustomerAttributesAllCacheKey, () =>
            {
        ...
        public virtual CustomerAttribute GetCustomerAttributeById(int customerAttributeId)
        {
            ...
            var key = string.Format(QNetCustomerServiceDefaults.CustomerAttributesByIdCacheKey, customerAttributeId);
        ...
        {
            var key = string.Format(QNetCustomerServiceDefaults.CustomerAttributeValuesAllCacheKey, customerAttributeId);
        ...
        public virtual CustomerAttributeValue GetCustomerAttributeValueById(int customerAttributeValueId)
        {
            ...
            var key = string.Format(QNetCustomerServiceDefaults.CustomerAttributeValuesByIdCacheKey, customerAttributeValueId);
