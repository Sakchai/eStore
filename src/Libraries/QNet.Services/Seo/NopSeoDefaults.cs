namespace QNet.Services.Seo
{
    ...
    /// </summary>
    public static partial class QNetSeoDefaults
    {
        /// <summary>
        ...
        /// {2} : language ID
        /// </remarks>
        public static string UrlRecordActiveByIdNameLanguageCacheKey => "QNet.urlrecord.active.id-name-language-{0}-{1}-{2}";

        /// <summary>
        /// Gets a key for caching
        /// </summary>
        public static string UrlRecordAllCacheKey => "QNet.urlrecord.all";
        ...
        /// {0} : slug
        /// </remarks>
        public static string UrlRecordBySlugCacheKey => "QNet.urlrecord.active.slug-{0}";

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string UrlRecordPrefixCacheKey => "QNet.urlrecord.";
