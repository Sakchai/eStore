...
namespace QNet.Services.ExportImport
{
    ...
    public partial class ImportManager : IImportManager
    {
        ...
        private string DownloadFile(string urlString, IList<string> downloadedFiles)
        {
            ...
            try
            {
                var client = _httpClientFactory.CreateClient(QNetHttpDefaults.DefaultHttpClient);
        ...
        public virtual void ImportProductsFromXlsx(Stream stream)
        {
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                if (worksheet == null)
                    throw new QNetException("No worksheet found");
            ...
            using (var reader = new StreamReader(stream))
            {
                while (!reader.EndOfStream)
                {
                    ...
                    else if (tmp.Length == 3)
                    {
                        ...
                        throw new QNetException("Wrong file format");
