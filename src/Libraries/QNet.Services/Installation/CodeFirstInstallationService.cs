...
namespace QNet.Services.Installation
{
    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        {
            //duplicate of ValidateSeName method of \QNet.Services\Seo\UrlRecordService.cs (we cannot inject it here)
            if (entity == null)
            ...
            //max length
            seName = CommonHelper.EnsureMaximumLength(seName, QNetSeoDefaults.SearchEngineNameLength);
        ...
        {
            return _fileProvider.GetAbsolutePath(QNetInstallationDefaults.SampleImagesPath);
        }
        ...
        protected virtual void InstallSampleCustomers()
        {
            var crRegistered = _customerRoleRepository.Table.FirstOrDefault(customerRole =>
                customerRole.SystemName.Equals(QNetCustomerDefaults.RegisteredRoleName,
            ...
            //second user
            var secondUserEmail = "steve_gates@QNet.com";
            ...
            _genericAttributeService.SaveAttribute(secondUser, QNetCustomerDefaults.FirstNameAttribute, defaultSecondUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(secondUser, QNetCustomerDefaults.LastNameAttribute, defaultSecondUserAddress.LastName);
            ...
            //third user
            var thirdUserEmail = "arthur_holmes@QNet.com";
            ...
            //set default customer name
            _genericAttributeService.SaveAttribute(thirdUser, QNetCustomerDefaults.FirstNameAttribute, defaultThirdUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(thirdUser, QNetCustomerDefaults.LastNameAttribute, defaultThirdUserAddress.LastName);
            ...
            //fourth user
            var fourthUserEmail = "james_pan@QNet.com";
            ...
            //set default customer name
            _genericAttributeService.SaveAttribute(fourthUser, QNetCustomerDefaults.FirstNameAttribute, defaultFourthUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(fourthUser, QNetCustomerDefaults.LastNameAttribute, defaultFourthUserAddress.LastName);
            ...
            //fifth user
            var fifthUserEmail = "brenda_lindgren@QNet.com";
            ...
            //set default customer name
            _genericAttributeService.SaveAttribute(fifthUser, QNetCustomerDefaults.FirstNameAttribute,
                defaultFifthUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(fifthUser, QNetCustomerDefaults.LastNameAttribute,
            ...
            //sixth user
            var sixthUserEmail = "victoria_victoria@QNet.com";
            ...
            //set default customer name
            _genericAttributeService.SaveAttribute(sixthUser, QNetCustomerDefaults.FirstNameAttribute, defaultSixthUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(sixthUser, QNetCustomerDefaults.LastNameAttribute, defaultSixthUserAddress.LastName);
        ...
        protected virtual void InstallCustomersAndUsers(string defaultUserEmail, string defaultUserPassword)
        {
            var crAdministrators = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = QNetCustomerDefaults.AdministratorsRoleName
            };
            ...
            var crRegistered = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = QNetCustomerDefaults.RegisteredRoleName
            };
            var crGuests = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = QNetCustomerDefaults.GuestsRoleName
            };
            var crVendors = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = QNetCustomerDefaults.VendorsRoleName
            };
            ...
            //set default customer name
            _genericAttributeService.SaveAttribute(adminUser, QNetCustomerDefaults.FirstNameAttribute, "John");
            _genericAttributeService.SaveAttribute(adminUser, QNetCustomerDefaults.LastNameAttribute, "Smith");
            ...
            var searchEngineUser = new Customer
            {
                ...
                SystemName = QNetCustomerDefaults.SearchEngineCustomerName,
                CreatedOnUtc = DateTime.UtcNow,
                LastActivityDateUtc = DateTime.UtcNow,
                RegisteredInStoreId = storeId
            };
            ...
            var backgroundTaskUser = new Customer
            {
                ...
                Active = true,
                IsSystemAccount = true,
                SystemName = QNetCustomerDefaults.BackgroundTaskCustomerName,
                CreatedOnUtc = DateTime.UtcNow,
                LastActivityDateUtc = DateTime.UtcNow,
                RegisteredInStoreId = storeId
            };
        ...
        protected virtual void InstallOrders()
        {
            ...
            //first order
            var firstCustomer = _customerRepository.Table.First(c => c.Email.Equals("steve_gates@QNet.com"));
            ...
            var firstOrderItem3 = new OrderItem
            {
                ...
                PriceExclTax = 25M,
                OriginalProductCost = decimal.Zero,
                AttributeDescription = "From: Steve Gates &lt;steve_gates@QNet.com&gt;<br />For: Brenda Lindgren &lt;brenda_lindgren@QNet.com&gt;",
                AttributesXml = "<Attributes><GiftCardInfo><RecipientName>Brenda Lindgren</RecipientName><RecipientEmail>brenda_lindgren@QNet.com</RecipientEmail><SenderName>Steve Gates</SenderName><SenderEmail>steve_gates@gmail.com</SenderEmail><Message></Message></GiftCardInfo></Attributes>",
                Quantity = 1,
                DiscountAmountInclTax = decimal.Zero,
                DiscountAmountExclTax = decimal.Zero,
                DownloadCount = 0,
            ...
            var firstOrderGiftcard = new GiftCard
            {
                ...
                RecipientEmail = "brenda_lindgren@QNet.com",
                SenderName = "Steve Gates",
                SenderEmail = "steve_gates@QNet.com",
            ...
            //second order
            var secondCustomer = _customerRepository.Table.First(c => c.Email.Equals("arthur_holmes@QNet.com"));
            ...
            //third order
            var thirdCustomer = _customerRepository.Table.First(c => c.Email.Equals("james_pan@QNet.com"));
            ...
            //fourth order
            var fourthCustomer = _customerRepository.Table.First(c => c.Email.Equals("brenda_lindgren@QNet.com"));
            ...
            //fifth order
            var fifthCustomer = _customerRepository.Table.First(c => c.Email.Equals("victoria_victoria@QNet.com"));
        ...
        protected virtual void InstallSettings()
        {
            ...
            settingService.SaveSetting(new CommonSettings
            {
                ...
                SupportPreviousQNetcommerceVersions = true,
            ...
            settingService.SaveSetting(new CustomerSettings
            {
                ...
                HashedPasswordFormat = QNetCustomerServiceDefaults.DefaultHashedPasswordFormat,
                PasswordMinLength = 6,
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                FacebookLink = "http://www.facebook.com/QNet",
                TwitterLink = "https://twitter.com/QNet",
                YoutubeLink = "http://www.youtube.com/user/QNet",
                HidePoweredByQNetCommerce = false
            });
        ...
        protected virtual void InstallNews(string defaultUserEmail)
        {
            ...
            var news = new List<NewsItem>
            {
                new NewsItem
                {
                    ...
                    Language = defaultLanguage,
                    Title = "About QNet",
                    Short = "It's stable and highly usable. From downloads to documentation, www.QNet.com offers a comprehensive base of information, resources, and support to the QNet community.",
                    Full = "<p>For full feature list go to <a href=\"https://www.QNet.com\">QNet.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow
                },
                new NewsItem
                {
                    AllowComments = true,
                    Language = defaultLanguage,
                    Title = "QNet new release!",
                    Short = "QNet includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! QNet is a fully customizable shopping cart",
                    Full = "<p>QNet includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow.AddSeconds(1)
                },
                new NewsItem
                {
                    ...
                    Short = "The new QNet store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                new ScheduleTask
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "QNet.Services.Messages.QueuedMessagesSendTask, QNet.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "QNet.Services.Common.KeepAliveTask, QNet.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "QNet.Services.Customers.DeleteGuestsTask, QNet.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "QNet.Services.Caching.ClearCacheTask, QNet.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "QNet.Services.Logging.ClearLogTask, QNet.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "QNet.Services.Directory.UpdateExchangeRateTask, QNet.Services",
                    Enabled = true,
                    StopOnError = false
                }
            };
