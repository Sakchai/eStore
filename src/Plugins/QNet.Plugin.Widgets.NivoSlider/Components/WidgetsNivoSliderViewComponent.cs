...
using QNet.Plugin.Widgets.NivoSlider.Infrastructure.Cache;
using QNet.Plugin.Widgets.NivoSlider.Models;
using QNet.Services.Configuration;
using QNet.Services.Media;
using QNet.Web.Framework.Components;

namespace QNet.Plugin.Widgets.NivoSlider.Components
{
    [ViewComponent(Name = "WidgetsNivoSlider")]
    public class WidgetsNivoSliderViewComponent : QNetViewComponent
    {
