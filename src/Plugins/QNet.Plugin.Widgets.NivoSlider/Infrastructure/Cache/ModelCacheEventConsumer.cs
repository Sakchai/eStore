...
namespace QNet.Plugin.Widgets.NivoSlider.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeletedEvent<Setting>>
    {
        ...
        /// </remarks>
        public const string PICTURE_URL_MODEL_KEY = "QNet.plugins.widgets.nivoslider.pictureurl-{0}-{1}";
        public const string PICTURE_URL_PATTERN_KEY = "QNet.plugins.widgets.nivoslider";
