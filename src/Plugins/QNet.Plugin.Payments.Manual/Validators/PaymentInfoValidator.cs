...
using QNet.Plugin.Payments.Manual.Models;
using QNet.Services.Localization;
using QNet.Web.Framework.Validators;

namespace QNet.Plugin.Payments.Manual.Validators
{
    public partial class PaymentInfoValidator : BaseQNetValidator<PaymentInfoModel>
    {
