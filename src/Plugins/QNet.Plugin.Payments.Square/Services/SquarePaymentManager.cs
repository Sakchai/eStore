...
namespace QNet.Plugin.Payments.Square.Services
{
    ...
    public class SquarePaymentManager
    {
        ...
        private Configuration CreateApiConfiguration()
        {
            ...
            {
                throw new QNetException("Sandbox access token should not be empty");
            }
        ...
        public IList<Location> GetActiveLocations()
        {
            try
            {
                ...
                if (listLocationsResponse == null)
                    throw new QNetException("No service response");
                ...
                if (listLocationsResponse.Errors?.Any() ?? false)
                {
                    ...
                    throw new QNetException($"There are errors in the service response. {errorsMessage}");
                }
                ...
                if (!activeLocations?.Any() ?? true)
                    throw new QNetException("There are no active locations for the account");
        ...
        public (Transaction, string) GetTransaction(string transactionId)
        {
            try
            {
                ...
                if (selectedLocation == null)
                    throw new QNetException("Location is a required parameter for payment requests");
