...
using QNet.Core;
using QNet.Plugin.ExternalAuth.Facebook.Models;
...
namespace QNet.Plugin.ExternalAuth.Facebook.Controllers
{
    public class FacebookAuthenticationController : BasePluginController
    {
        ...
        public IActionResult Login(string returnUrl)
        {
            ...
            if (!methodIsAvailable)
                throw new QNetException("Facebook authentication module cannot be loaded");
            ...
            {
                throw new QNetException("Facebook authentication module not configured");
            }
