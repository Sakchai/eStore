...
using QNet.Plugin.Payments.Qualpay.Validators;
...
namespace QNet.Plugin.Payments.Qualpay
{
    /// <summary>
    ...
    public class QualpayProcessor : BasePlugin, IPaymentMethod, IWidgetPlugin
    {
        ...
        public override void Install()
        {
            ...
            //locales
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Payments.Qualpay.Domain.Authorization", "Authorization");
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Payments.Qualpay.Domain.Sale", "Sale (authorization and capture)");
        ...
        public override void Uninstall()
        {
            ...
            //locales
            _localizationService.DeletePluginLocaleResource("Enums.QNet.Plugin.Payments.Qualpay.Domain.Authorization");
            _localizationService.DeletePluginLocaleResource("Enums.QNet.Plugin.Payments.Qualpay.Domain.Sale");
