namespace QNet.Plugin.Payments.Qualpay
{
    ...
    public class QualpayDefaults
    {
        ...
        /// </summary>
        public static string UserAgent => "QNet-plugin";

        /// <summary>
        /// QNet developer application ID
        /// </summary>
        public static string DeveloperId => "QNet";
        ...
        /// Webhook label
        /// </summary>
        public static string WebhookLabel => "QNet-plugin-webhook";
