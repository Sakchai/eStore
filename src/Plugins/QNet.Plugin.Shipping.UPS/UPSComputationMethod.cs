...
using System.Linq;
using QNet.Core;
using QNet.Plugin.Shipping.UPS.Domain;
...
using QNet.Services.Shipping.Tracking;

namespace QNet.Plugin.Shipping.UPS
{
    /// <summary>
    ...
    public class UPSComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        public override void Install()
        {
            ...
            //locales
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Shipping.UPS.PackingType.PackByDimensions", "Pack by dimensions");
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Shipping.UPS.PackingType.PackByOneItemPerPackage", "Pack by one item per package");
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Shipping.UPS.PackingType.PackByVolume", "Pack by volume");
