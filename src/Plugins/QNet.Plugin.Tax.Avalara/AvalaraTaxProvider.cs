...
using QNet.Web.Framework.Infrastructure;

namespace QNet.Plugin.Tax.Avalara
{
    /// <summary>
    ...
    public class AvalaraTaxProvider : BasePlugin, ITaxProvider, IWidgetPlugin
    {
        ...
        /// <summary>
        /// Map QNet address to Avalara model address info
        /// </summary>
            ...
            return order.OrderItems.Select(orderItem =>
            {
                ...
                var useEuVatRules = _taxSettings.EuVatEnabled
                    ...
                    && ((order.BillingAddress.Country
                        ?? _countryService.GetCountryById(_genericAttributeService.GetAttribute<int>(order.Customer, QNetCustomerDefaults.CountryIdAttribute))
                        ?? _countryService.GetCountryByTwoLetterIsoCode(_geoLookupService.LookupCountryIsoCode(order.Customer.LastIpAddress)))
                        ?.SubjectToVat ?? false)
                    && _genericAttributeService.GetAttribute<int>(order.Customer, QNetCustomerDefaults.VatNumberStatusIdAttribute) != (int)VatNumberStatus.Valid;
                if (useEuVatRules)
                {
        ...
        public override void Install()
        {
            ...
            //locales
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.Create", "Create request");
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.CreateResponse", "Create response");
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.Error", "Error");
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.Refund", "Refund request");
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.RefundResponse", "Refund response");
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.Void", "Void request");
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.VoidResponse", "Void response");
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.TaxOriginAddressType.DefaultTaxAddress", "Default tax address");
            _localizationService.AddOrUpdatePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.TaxOriginAddressType.ShippingOrigin", "Shipping origin address");
        ...
        public override void Uninstall()
        {
            ...
            //locales
            _localizationService.DeletePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.Create");
            _localizationService.DeletePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.CreateResponse");
            _localizationService.DeletePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.Error");
            _localizationService.DeletePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.Refund");
            _localizationService.DeletePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.RefundResponse");
            _localizationService.DeletePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.Void");
            _localizationService.DeletePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.LogType.VoidResponse");
            _localizationService.DeletePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.TaxOriginAddressType.DefaultTaxAddress");
            _localizationService.DeletePluginLocaleResource("Enums.QNet.Plugin.Tax.Avalara.Domain.TaxOriginAddressType.ShippingOrigin");
