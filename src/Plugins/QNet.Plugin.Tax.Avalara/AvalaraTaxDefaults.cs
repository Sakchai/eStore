...
namespace QNet.Plugin.Tax.Avalara
{
    ...
    public class AvalaraTaxDefaults
    {
        ...
        /// </summary>
        public static string ApplicationName => "QNet-AvalaraTaxRateProvider|a0o33000004BoPM";

        /// <summary>
        /// Avalara tax provider version (used a QNet version here)
        /// </summary>
        public static string ApplicationVersion => $"v{QNetVersion.CurrentVersion}";
        ...
        /// {4} - Zip postal code
        /// </remarks>
        public static string TaxRateCacheKey => "QNet.avalara.taxrate.address-{0}-{1}-{2}-{3}-{4}";

        /// <summary>
        /// Key for caching Avalara tax code types
        /// </summary>
        public static string TaxCodeTypesCacheKey => "QNet.avalara.taxcodetypes";

        /// <summary>
        /// Key for caching Avalara system entity use codes
        /// </summary>
        public static string EntityUseCodesCacheKey => "QNet.avalara.entityusecodes";
