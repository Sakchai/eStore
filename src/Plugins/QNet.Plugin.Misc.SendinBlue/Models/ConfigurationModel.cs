...
namespace QNet.Plugin.Misc.SendinBlue.Models
{
    ...
    public class ConfigurationModel : BaseQNetModel
    {
        ...
        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.ApiKey")]
        public string ApiKey { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.List")]
        public int ListId { get; set; }
        public bool ListId_OverrideForStore { get; set; }
        public IList<SelectListItem> AvailableLists { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.SmtpKey")]
        public string SmtpKey { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.UseSmtp")]
        public bool UseSmtp { get; set; }
        public bool UseSmtp_OverrideForStore { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.Sender")]
        public string SenderId { get; set; }
        public bool SenderId_OverrideForStore { get; set; }
        public IList<SelectListItem> AvailableSenders { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.UseSmsNotifications")]
        public bool UseSmsNotifications { get; set; }
        public bool UseSmsNotifications_OverrideForStore { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.SmsSenderName")]
        public string SmsSenderName { get; set; }
        public bool SmsSenderName_OverrideForStore { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.StoreOwnerPhoneNumber")]
        public string StoreOwnerPhoneNumber { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.CampaignList")]
        public int CampaignListId { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.CampaignSenderName")]
        public string CampaignSenderName { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.CampaignText")]
        public string CampaignText { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.MaKey")]
        public string MarketingAutomationKey { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.UseMarketingAutomation")]
        public bool UseMarketingAutomation { get; set; }
        public bool UseMarketingAutomation_OverrideForStore { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.AccountInfo")]
        public string AccountInfo { get; set; }

        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.AllowedTokens")]
        ...
        [QNetResourceDisplayName("Plugins.Misc.SendinBlue.Fields.TrackingScript")]
