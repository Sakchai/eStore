...
using QNet.Plugin.Misc.SendinBlue.Models;
...
namespace QNet.Plugin.Misc.SendinBlue.Controllers
{
    public class SendinBlueController : BasePluginController
    {
        ...
        public IActionResult ImportContacts(BaseQNetModel model, IFormCollection form)
        {
            try
            {
                //logging info
