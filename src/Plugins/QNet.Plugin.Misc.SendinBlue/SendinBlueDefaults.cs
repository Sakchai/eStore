...
namespace QNet.Plugin.Misc.SendinBlue
{
    ...
    public static class SendinBlueDefaults
    {
        ...
        /// </summary>
        public static string UserAgent => $"QNet-{QNetVersion.CurrentVersion}";
        ...
        /// </summary>
        public static string SynchronizationTask => "QNet.Plugin.Misc.SendinBlue.Services.SynchronizationTask";
