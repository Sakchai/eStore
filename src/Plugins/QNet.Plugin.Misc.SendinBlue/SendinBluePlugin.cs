...
namespace QNet.Plugin.Misc.SendinBlue
{
    /// <summary>
    ...
    public class SendinBluePlugin : BasePlugin, IMiscPlugin, IWidgetPlugin
    {
        ...
        public override void Install()
        {
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Misc.SendinBlue.Fields.List.Hint", "Select the SendinBlue list where your QNet newsletter subscribers will be added.");
