...
{
    public partial class ProductReviewOverviewModel : BaseQNetModel
    {
    ...
    public partial class ProductReviewsModel : BaseQNetModel
    {
    ...
    public partial class ReviewTypeModel : BaseQNetEntityModel
    {
    ...
    public partial class ProductReviewHelpfulnessModel : BaseQNetModel
    {
    ...
    public partial class AddProductReviewModel : BaseQNetModel
    {
        [QNetResourceDisplayName("Reviews.Fields.Title")]
        public string Title { get; set; }
        
        [QNetResourceDisplayName("Reviews.Fields.ReviewText")]
        public string ReviewText { get; set; }

        [QNetResourceDisplayName("Reviews.Fields.Rating")]
        public int Rating { get; set; }
    ...
    public partial class AddProductReviewReviewTypeMappingModel : BaseQNetEntityModel
    {
        public int ProductReviewId { get; set; }
    ...
    public partial class ProductReviewReviewTypeMappingModel : BaseQNetEntityModel
    {
        public int ProductReviewId { get; set; }
