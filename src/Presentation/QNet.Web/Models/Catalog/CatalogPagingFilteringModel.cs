...
namespace QNet.Web.Models.Catalog
{
    ...
    public partial class CatalogPagingFilteringModel : BasePageableModel
    {
        ...
        /// Price range filter model
        /// </summary>
        public partial class PriceRangeFilterModel : BaseQNetModel
        {
            #region Const
        ...
        /// </summary>
        public partial class PriceRangeFilterItem : BaseQNetModel
        {
            /// <summary>
            /// From
            /// </summary>
        ...
        /// Specification filter model
        /// </summary>
        public partial class SpecificationFilterModel : BaseQNetModel
        {
            #region Const
                ...
                IWebHelper webHelper, IWorkContext workContext, ICacheManager cacheManager)
            {
                ...
                var cacheKey = string.Format(QNetModelCacheDefaults.SpecsFilterModelKey, optionIds, workContext.WorkingLanguage.Id);
        ...
        /// </summary>
        public partial class SpecificationFilterItem : BaseQNetModel
        {
            /// <summary>
