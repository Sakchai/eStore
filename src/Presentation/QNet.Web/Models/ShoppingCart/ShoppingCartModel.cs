...
namespace QNet.Web.Models.ShoppingCart
{
    public partial class ShoppingCartModel : BaseQNetModel
    {
        ...
        public partial class CheckoutAttributeValueModel : BaseQNetEntityModel
        {
            public string Name { get; set; }
        ...
        public partial class DiscountBoxModel: BaseQNetModel
        {
            ...
            public class DiscountInfoModel : BaseQNetEntityModel
            {
                public string CouponCode { get; set; }
            }
        }

        public partial class GiftCardBoxModel : BaseQNetModel
        {
            public bool Display { get; set; }
        ...
        public partial class OrderReviewDataModel : BaseQNetModel
        {
