...
CREATE TABLE `pollanswer` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_PollAnswer_PollId` (`PollId`),
  CONSTRAINT `FK_PollAnswer_Poll_PollId` FOREIGN KEY (`PollId`) REFERENCES `poll` (`Id`) ON DELETE CASCADE
...
INSERT INTO `pollanswer` VALUES (1,1,'Excellent',0,1),(2,1,'Good',0,2),(3,1,'Poor',0,3),(4,1,'Very bad',0,4);
...
-- Dump completed on 2019-08-31 12:14:51
