...
CREATE TABLE `productattributecombination` (
  ...
  `AllowOutOfStockOrders` bit(1) NOT NULL,
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_ProductAttributeCombination_ProductId` (`ProductId`),
  CONSTRAINT `FK_ProductAttributeCombination_Product_ProductId` FOREIGN KEY (`ProductId`) REFERENCES `product` (`Id`) ON DELETE CASCADE
...
-- Dump completed on 2019-08-31 12:14:56
