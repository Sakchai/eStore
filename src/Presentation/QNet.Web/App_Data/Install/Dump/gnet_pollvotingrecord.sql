...
CREATE TABLE `pollvotingrecord` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_PollVotingRecord_CustomerId` (`CustomerId`),
  KEY `IX_PollVotingRecord_PollAnswerId` (`PollAnswerId`),
  CONSTRAINT `FK_PollVotingRecord_Customer_CustomerId` FOREIGN KEY (`CustomerId`) REFERENCES `customer` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `FK_PollVotingRecord_PollAnswer_PollAnswerId` FOREIGN KEY (`PollAnswerId`) REFERENCES `pollanswer` (`Id`) ON DELETE CASCADE
