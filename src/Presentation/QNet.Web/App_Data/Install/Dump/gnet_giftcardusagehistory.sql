...
CREATE TABLE `giftcardusagehistory` (
  ...
  `UsedWithOrderId` int(11) NOT NULL,
  ...
  CONSTRAINT `FK_GiftCardUsageHistory_Order_UsedWithOrderId` FOREIGN KEY (`UsedWithOrderId`) REFERENCES `order` (`Id`) ON DELETE CASCADE
