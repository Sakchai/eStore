...
CREATE TABLE `forums_topic` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_Forums_Topic_CustomerId` (`CustomerId`),
  KEY `IX_Forums_Topic_ForumId` (`ForumId`),
  CONSTRAINT `FK_Forums_Topic_Customer_CustomerId` FOREIGN KEY (`CustomerId`) REFERENCES `customer` (`Id`),
  CONSTRAINT `FK_Forums_Topic_Forums_Forum_ForumId` FOREIGN KEY (`ForumId`) REFERENCES `forums_forum` (`Id`) ON DELETE CASCADE
