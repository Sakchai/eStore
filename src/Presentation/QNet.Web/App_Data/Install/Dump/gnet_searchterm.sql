...
CREATE TABLE `searchterm` (
  ...
  `Keyword` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
INSERT INTO `searchterm` VALUES (1,'computer',1,34),(2,'camera',1,30),(3,'jewelry',1,27),(4,'shoes',1,26),(5,'jeans',1,19),(6,'gift',1,10);
