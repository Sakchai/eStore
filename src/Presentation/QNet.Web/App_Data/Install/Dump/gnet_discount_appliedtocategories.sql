...
CREATE TABLE `discount_appliedtocategories` (
  ...
  CONSTRAINT `FK_Discount_AppliedToCategories_Category_Category_Id` FOREIGN KEY (`Category_Id`) REFERENCES `category` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `FK_Discount_AppliedToCategories_Discount_Discount_Id` FOREIGN KEY (`Discount_Id`) REFERENCES `discount` (`Id`) ON DELETE CASCADE
...
-- Dump completed on 2019-08-31 12:14:52
