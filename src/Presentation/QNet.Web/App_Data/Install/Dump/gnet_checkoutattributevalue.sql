...
CREATE TABLE `checkoutattributevalue` (
  ...
  `CheckoutAttributeId` int(11) NOT NULL,
...
INSERT INTO `checkoutattributevalue` VALUES (1,1,'No',NULL,0.0000,0.0000,1,1),(2,1,'Yes',NULL,10.0000,0.0000,0,2);
...
-- Dump completed on 2019-08-31 12:15:37
