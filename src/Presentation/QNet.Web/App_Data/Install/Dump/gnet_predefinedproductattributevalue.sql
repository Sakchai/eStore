...
CREATE TABLE `predefinedproductattributevalue` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_PredefinedProductAttributeValue_ProductAttributeId` (`ProductAttributeId`),
  CONSTRAINT `FK_PredefinedProductAttributeValue_ProductAttribute_ProductAtt4` FOREIGN KEY (`ProductAttributeId`) REFERENCES `productattribute` (`Id`) ON DELETE CASCADE
