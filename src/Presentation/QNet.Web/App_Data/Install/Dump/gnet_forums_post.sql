...
CREATE TABLE `forums_post` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_Forums_Post_CustomerId` (`CustomerId`),
  KEY `IX_Forums_Post_TopicId` (`TopicId`),
  CONSTRAINT `FK_Forums_Post_Customer_CustomerId` FOREIGN KEY (`CustomerId`) REFERENCES `customer` (`Id`),
  CONSTRAINT `FK_Forums_Post_Forums_Topic_TopicId` FOREIGN KEY (`TopicId`) REFERENCES `forums_topic` (`Id`) ON DELETE CASCADE
...
-- Dump completed on 2019-08-31 12:15:26
