...
CREATE TABLE `vendornote` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_VendorNote_VendorId` (`VendorId`),
  CONSTRAINT `FK_VendorNote_Vendor_VendorId` FOREIGN KEY (`VendorId`) REFERENCES `vendor` (`Id`) ON DELETE CASCADE
...
-- Dump completed on 2019-08-31 12:15:43
