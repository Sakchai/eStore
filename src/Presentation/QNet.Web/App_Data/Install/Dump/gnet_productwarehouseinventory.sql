...
CREATE TABLE `productwarehouseinventory` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_ProductWarehouseInventory_ProductId` (`ProductId`),
  KEY `IX_ProductWarehouseInventory_WarehouseId` (`WarehouseId`),
  CONSTRAINT `FK_ProductWarehouseInventory_Product_ProductId` FOREIGN KEY (`ProductId`) REFERENCES `product` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `FK_ProductWarehouseInventory_Warehouse_WarehouseId` FOREIGN KEY (`WarehouseId`) REFERENCES `warehouse` (`Id`) ON DELETE CASCADE
...
-- Dump completed on 2019-08-31 12:15:03
