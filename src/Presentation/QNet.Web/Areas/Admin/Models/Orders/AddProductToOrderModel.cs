...
namespace QNet.Web.Areas.Admin.Models.Orders
{
    ...
    /// </summary>
    public partial class AddProductToOrderModel : BaseQNetModel
    {
        #region Ctor
        ...
        [QNetResourceDisplayName("Admin.Orders.Products.AddNew.UnitPriceInclTax")]
        public decimal UnitPriceInclTax { get; set; }
        [QNetResourceDisplayName("Admin.Orders.Products.AddNew.UnitPriceExclTax")]
        public decimal UnitPriceExclTax { get; set; }

        [QNetResourceDisplayName("Admin.Orders.Products.AddNew.Quantity")]
        public int Quantity { get; set; }

        [QNetResourceDisplayName("Admin.Orders.Products.AddNew.SubTotalInclTax")]
        public decimal SubTotalInclTax { get; set; }
        [QNetResourceDisplayName("Admin.Orders.Products.AddNew.SubTotalExclTax")]
