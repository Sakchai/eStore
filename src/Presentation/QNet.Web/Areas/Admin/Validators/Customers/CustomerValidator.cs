...
{
    public partial class CustomerValidator : BaseQNetValidator<CustomerModel>
    {
        ...
        private bool IsRegisteredCustomerRoleChecked(CustomerModel model, ICustomerService customerService)
        {
            ...
            var isInRegisteredRole = newCustomerRoles.FirstOrDefault(cr => cr.SystemName == QNetCustomerDefaults.RegisteredRoleName) != null;
