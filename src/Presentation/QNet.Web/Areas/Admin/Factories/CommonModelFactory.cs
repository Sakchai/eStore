...
namespace QNet.Web.Areas.Admin.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        private readonly QNetConfig _nopConfig;
        ...
        public virtual SystemInfoModel PrepareSystemInfoModel(SystemInfoModel model)
        {
            ...
            model.QNetVersion = QNetVersion.CurrentVersion;
        ...
        public virtual CommonStatisticsModel PrepareCommonStatisticsModel()
        {
            ...
            var customerRoleIds = new[] { _customerService.GetCustomerRoleBySystemName(QNetCustomerDefaults.RegisteredRoleName).Id };
