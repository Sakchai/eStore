...
namespace QNet.Web.Areas.Admin.Factories
{
    ...
    public partial class PluginModelFactory : IPluginModelFactory
    {
        ...
        public virtual OfficialFeedPluginSearchModel PrepareOfficialFeedPluginSearchModel(OfficialFeedPluginSearchModel searchModel)
        {
            ...
            var currentVersionItem = searchModel.AvailableVersions.FirstOrDefault(x => x.Text.Contains(QNetVersion.CurrentVersion));
        ...
        {
            var cacheKey = string.Format(QNetPluginDefaults.AdminNavigationPluginsCacheKey, _workContext.CurrentCustomer.Id);
