...
using QNet.Web.Areas.Admin.Models.Affiliates;
...
namespace QNet.Web.Areas.Admin.Infrastructure.Mapper
{
    /// <summary>
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        public AdminMapperConfiguration()
        {
            ...
            {
                //exclude Form and CustomProperties from mapping BaseQNetModel
                if (typeof(BaseQNetModel).IsAssignableFrom(mapConfiguration.DestinationType))
                {
                    //map.ForMember(nameof(BaseQNetModel.Form), options => options.Ignore());
                    map.ForMember(nameof(BaseQNetModel.CustomProperties), options => options.Ignore());
                }
