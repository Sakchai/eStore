...
namespace QNet.Web.Areas.Admin.Infrastructure.Mapper.Extensions
{
    /// <summary>
    ...
    public static class MappingExtensions
    {
        ...
        public static TModel ToModel<TModel>(this BaseEntity entity) where TModel : BaseQNetEntityModel
        {
            if (entity == null)
        ...
        public static TModel ToModel<TEntity, TModel>(this TEntity entity, TModel model) 
            where TEntity : BaseEntity where TModel : BaseQNetEntityModel
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToSettingsModel<TModel>(this ISettings settings) where TModel : BaseQNetModel, ISettingsModel
        {
            if (settings == null)
        ...
        public static TSettings ToSettings<TSettings, TModel>(this TModel model, TSettings settings)
            where TSettings : class, ISettings where TModel : BaseQNetModel, ISettingsModel
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToPluginModel<TModel>(this IPlugin plugin) where TModel : BaseQNetModel, IPluginModel
        {
            if (plugin == null)
        ...
        public static TModel ToPluginModel<TModel>(this PluginDescriptor pluginDescriptor, TModel model = null) 
            where TModel : BaseQNetModel, IPluginModel
        {
