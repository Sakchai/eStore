...
namespace QNet.Web.Areas.Admin.Controllers
{
    public partial class VendorController : BaseAdminController
    {
        ...
        protected virtual string ParseVendorAttributes(IFormCollection form)
        {
            ...
            {
                var controlId = $"{QNetAttributePrefixDefaults.Vendor}{attribute.Id}";
        ...
        public virtual IActionResult Create(VendorModel model, bool continueEditing, IFormCollection form)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //vendor attributes
                _genericAttributeService.SaveAttribute(vendor, QNetVendorDefaults.VendorAttributes, vendorAttributesXml);
