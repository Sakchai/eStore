...
namespace QNet.Web.Factories
{
    ...
    public partial class TopicModelFactory : ITopicModelFactory
    {
        ...
        {
            var cacheKey = string.Format(QNetModelCacheDefaults.TopicModelByIdKey,
                topicId,
        ...
        {
            var cacheKey = string.Format(QNetModelCacheDefaults.TopicModelBySystemNameKey,
                systemName,
                _workContext.WorkingLanguage.Id,
                _storeContext.CurrentStore.Id,
                string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()));
        ...
        {
            var templateCacheKey = string.Format(QNetModelCacheDefaults.TopicTemplateModelKey, topicTemplateId);
