...
namespace QNet.Web.Factories
{
    ...
    public partial class BlogModelFactory : IBlogModelFactory
    {
        ...
        public virtual BlogCommentModel PrepareBlogPostCommentModel(BlogComment blogComment)
        {
            ...
            if (_customerSettings.AllowCustomersToUploadAvatars)
            {
                model.CustomerAvatarUrl = _pictureService.GetPictureUrl(
                    _genericAttributeService.GetAttribute<int>(blogComment.Customer, QNetCustomerDefaults.AvatarPictureIdAttribute),
        ...
        public virtual void PrepareBlogPostModel(BlogPostModel model, BlogPost blogPost, bool prepareComments)
        {
            ...
            var cacheKey = string.Format(QNetModelCacheDefaults.BlogCommentsNumberKey, blogPost.Id, storeId, true);
        ...
        {
            var cacheKey = string.Format(QNetModelCacheDefaults.BlogTagsModelKey, _workContext.WorkingLanguage.Id, _storeContext.CurrentStore.Id);
        ...
        {
            var cacheKey = string.Format(QNetModelCacheDefaults.BlogMonthsModelKey, _workContext.WorkingLanguage.Id, _storeContext.CurrentStore.Id);
            var cachedModel = _cacheManager.Get(cacheKey, () =>
            {
