...
namespace QNet.Web.Factories
{
    ...
    public partial class ProductModelFactory : IProductModelFactory
    {
        ...
        protected virtual ProductReviewOverviewModel PrepareProductReviewOverviewModel(Product product)
        {
            ...
            {
                var cacheKey = string.Format(QNetModelCacheDefaults.ProductReviewsModelKey, product.Id, _storeContext.CurrentStore.Id);
        ...
        protected virtual PictureModel PrepareProductOverviewPictureModel(Product product, int? productThumbPictureSize = null)
        {
            ...
            var cacheKey = string.Format(QNetModelCacheDefaults.ProductDefaultPictureModelKey,
        ...
        protected virtual ProductDetailsModel.ProductBreadcrumbModel PrepareProductBreadcrumbModel(Product product)
        {
            ...
            var cacheKey = string.Format(QNetModelCacheDefaults.ProductBreadcrumbModelKey,
                    product.Id,
        ...
        protected virtual IList<ProductTagModel> PrepareProductTagModels(Product product)
        {
            ...
            var productTagsCacheKey = string.Format(QNetModelCacheDefaults.ProductTagByProductModelKey, 
                product.Id, 
                _workContext.WorkingLanguage.Id,
                string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
                _storeContext.CurrentStore.Id);
            ...
            foreach (var attribute in productAttributeMapping)
            {
                ...
                if (attribute.ShouldHaveValues())
                {
                    ...
                    foreach (var attributeValue in attributeValues)
                    {
                        ...
                        {
                            var productAttributeImageSquarePictureCacheKey = string.Format(QNetModelCacheDefaults.ProductAttributeImageSquarePictureModelKey,
        ...
        protected virtual IList<ManufacturerBriefInfoModel> PrepareProductManufacturerModels(Product product)
        {
            ...
            var manufacturersCacheKey = string.Format(QNetModelCacheDefaults.ProductManufacturersModelKey,
                     product.Id,
                     _workContext.WorkingLanguage.Id,
                     string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
                     _storeContext.CurrentStore.Id);
        ...
        protected virtual PictureModel PrepareProductDetailsPictureModel(Product product, bool isAssociatedProduct, out IList<PictureModel> allPictureModels)
        {
            ...
            var productPicturesCacheKey = string.Format(QNetModelCacheDefaults.ProductDetailsPicturesModelKey, product.Id, defaultPictureSize, isAssociatedProduct, _workContext.WorkingLanguage.Id, _webHelper.IsCurrentConnectionSecured(), _storeContext.CurrentStore.Id);
        ...
        public virtual string PrepareProductTemplateViewPath(Product product)
        {
            ...
            var templateCacheKey = string.Format(QNetModelCacheDefaults.ProductTemplateModelKey, product.ProductTemplateId);
        ...
        public virtual IList<ProductSpecificationModel> PrepareProductSpecificationModel(Product product)
        {
            ...
            var cacheKey = string.Format(QNetModelCacheDefaults.ProductSpecsModelKey, product.Id, _workContext.WorkingLanguage.Id);
