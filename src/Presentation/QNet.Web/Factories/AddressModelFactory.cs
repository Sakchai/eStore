    ...
    public partial class AddressModelFactory : IAddressModelFactory
    {
            ...
            string overrideAttributesXml = "")
        {
            ...
            if (address == null && prePopulateWithCustomerFields)
            {
                ...
                model.Address1 = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.StreetAddressAttribute);
                model.Address2 = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.StreetAddress2Attribute);
                ...
                model.PhoneNumber = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.PhoneAttribute);
                model.FaxNumber = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.FaxAttribute);
            }
