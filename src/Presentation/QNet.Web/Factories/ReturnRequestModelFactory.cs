...
namespace QNet.Web.Factories
{
    ...
    public partial class ReturnRequestModelFactory : IReturnRequestModelFactory
    {
        ...
        public virtual SubmitReturnRequestModel PrepareSubmitReturnRequestModel(SubmitReturnRequestModel model, Order order)
        {
            ...
            //return reasons
            model.AvailableReturnReasons = _cacheManager.Get(string.Format(QNetModelCacheDefaults.ReturnRequestReasonsModelKey, _workContext.WorkingLanguage.Id),
                () =>
                {
            ...
            //return actions
            model.AvailableReturnActions = _cacheManager.Get(string.Format(QNetModelCacheDefaults.ReturnRequestActionsModelKey, _workContext.WorkingLanguage.Id),
                () =>
                {
