...
namespace QNet.Web.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual LogoModel PrepareLogoModel()
        {
            ...
            var cacheKey = string.Format(QNetModelCacheDefaults.StoreLogoPath, _storeContext.CurrentStore.Id, _themeContext.WorkingThemeName, _webHelper.IsCurrentConnectionSecured());
        ...
        {
            var availableLanguages = _cacheManager.Get(string.Format(QNetModelCacheDefaults.AvailableLanguagesModelKey, _storeContext.CurrentStore.Id), () =>
            {
        ...
        public virtual HeaderLinksModel PrepareHeaderLinksModel()
        {
            ...
            if (unreadMessageCount > 0)
            {
                ...
                if (_forumSettings.ShowAlertForPM &&
                    !_genericAttributeService.GetAttribute<bool>(customer, QNetCustomerDefaults.NotifiedAboutNewPrivateMessagesAttribute, _storeContext.CurrentStore.Id))
                {
                    _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.NotifiedAboutNewPrivateMessagesAttribute, true, _storeContext.CurrentStore.Id);
        ...
        {
            //footer topics
            var topicCacheKey = string.Format(QNetModelCacheDefaults.TopicFooterModelKey,
            ...
            var model = new FooterModel
            {
                ...
                HidePoweredByQNetCommerce = _storeInformationSettings.HidePoweredByQNetCommerce,
        ...
        {
            var cacheKey = string.Format(QNetModelCacheDefaults.SitemapPageModelKey,
                _workContext.WorkingLanguage.Id,
                string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
                _storeContext.CurrentStore.Id);
        ...
        {
            var cacheKey = string.Format(QNetModelCacheDefaults.SitemapSeoModelKey, id,
                _workContext.WorkingLanguage.Id,
                string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
                _storeContext.CurrentStore.Id);
