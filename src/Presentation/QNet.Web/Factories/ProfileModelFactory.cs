    ...
    public partial class ProfileModelFactory : IProfileModelFactory
    {
        ...
        public virtual ProfileInfoModel PrepareProfileInfoModel(Customer customer)
        {
            ...
            if (_forumSettings.ForumsEnabled && _forumSettings.ShowCustomersPostCount)
            {
                ...
                totalPosts = _genericAttributeService.GetAttribute<int>(customer, QNetCustomerDefaults.ForumPostCountAttribute);
            }
            ...
            {
                var dob = _genericAttributeService.GetAttribute<DateTime?>(customer, QNetCustomerDefaults.DateOfBirthAttribute);
                if (dob.HasValue)
                {
