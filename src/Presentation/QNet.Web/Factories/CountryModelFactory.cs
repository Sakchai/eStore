...
using QNet.Web.Models.Directory;
...
namespace QNet.Web.Factories
{
    ...
    public partial class CountryModelFactory : ICountryModelFactory
    {
        ...
        public virtual IList<StateProvinceModel> GetStatesByCountryId(string countryId, bool addSelectStateItem)
        {
            ...
            var cacheKey = string.Format(QNetModelCacheDefaults.StateProvincesByCountryModelKey, countryId, addSelectStateItem, _workContext.WorkingLanguage.Id);
