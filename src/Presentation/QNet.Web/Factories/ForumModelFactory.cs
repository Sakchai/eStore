...
using QNet.Web.Framework.Extensions;
        ...
        public virtual ForumTopicPageModel PrepareForumTopicPageModel(ForumTopic forumTopic, int page)
        {
            ...
            foreach (var post in posts)
            {
                var forumPostModel = new ForumPostModel
                {
                    ...
                    ForumPostCount = _genericAttributeService.GetAttribute<int>(post.Customer, QNetCustomerDefaults.ForumPostCountAttribute),
                    ...
                    FormattedSignature = _forumService.FormatForumSignatureText(_genericAttributeService.GetAttribute<string>(post.Customer, QNetCustomerDefaults.SignatureAttribute)),
                };
                //created on string
                ...
                if (_customerSettings.AllowCustomersToUploadAvatars)
                {
                    forumPostModel.CustomerAvatarUrl = _pictureService.GetPictureUrl(
                        _genericAttributeService.GetAttribute<int>(post.Customer, QNetCustomerDefaults.AvatarPictureIdAttribute),
                ...
                {
                    var countryId = _genericAttributeService.GetAttribute<int>(post.Customer, QNetCustomerDefaults.CountryIdAttribute);
            ...
            string within, string limitDays, int page)
        {
            ...
            try
            {
                if (!string.IsNullOrWhiteSpace(searchterms))
                {
                    ...
                    {
                        throw new QNetException(string.Format(_localizationService.GetResource("Forum.SearchTermMinimumLengthIsNCharacters"),
