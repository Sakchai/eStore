...
namespace QNet.Web.Factories
{
    ...
    public partial class NewsModelFactory : INewsModelFactory
    {
        ...
        public virtual NewsCommentModel PrepareNewsCommentModel(NewsComment newsComment)
        {
            ...
            if (_customerSettings.AllowCustomersToUploadAvatars)
            {
                model.CustomerAvatarUrl = _pictureService.GetPictureUrl(
                    _genericAttributeService.GetAttribute<int>(newsComment.Customer, QNetCustomerDefaults.AvatarPictureIdAttribute),
        ...
        public virtual NewsItemModel PrepareNewsItemModel(NewsItemModel model, NewsItem newsItem, bool prepareComments)
        {
            ...
            var cacheKey = string.Format(QNetModelCacheDefaults.NewsCommentsNumberKey, newsItem.Id, storeId, true);
        ...
        {
            var cacheKey = string.Format(QNetModelCacheDefaults.HomepageNewsModelKey, _workContext.WorkingLanguage.Id, _storeContext.CurrentStore.Id);
