...
namespace QNet.Web.Factories
{
    ...
    public partial class PollModelFactory : IPollModelFactory
    {
        ...
        public virtual PollModel PreparePollModelBySystemName(string systemKeyword)
        {
            ...
            var cacheKey = string.Format(QNetModelCacheDefaults.PollBySystemNameModelKey, 
        ...
        {
            var cacheKey = string.Format(QNetModelCacheDefaults.HomepagePollsModelKey, 
