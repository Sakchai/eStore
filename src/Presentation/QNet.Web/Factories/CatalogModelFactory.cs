    ...
    public partial class CatalogModelFactory : ICatalogModelFactory
    {
        ...
        public virtual CategoryModel PrepareCategoryModel(Category category, CatalogPagingFilteringModel command)
        {
            ...
            if (_catalogSettings.CategoryBreadcrumbEnabled)
            {
                ...
                var breadcrumbCacheKey = string.Format(QNetModelCacheDefaults.CategoryBreadcrumbKey,
                    category.Id,
            ...
            //subcategories
            var subCategoriesCacheKey = string.Format(QNetModelCacheDefaults.CategorySubcategoriesKey,
                category.Id,
                pictureSize,
                string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
                _storeContext.CurrentStore.Id,
            ...
            model.SubCategories = _cacheManager.Get(subCategoriesCacheKey, () =>
                ...
                .Select(x =>
                {
                    ...
                    var categoryPictureCacheKey = string.Format(QNetModelCacheDefaults.CategoryPictureModelKey, x.Id, pictureSize, true, _workContext.WorkingLanguage.Id, _webHelper.IsCurrentConnectionSecured(), _storeContext.CurrentStore.Id);
            ...
            if (!_catalogSettings.IgnoreFeaturedProducts)
            {
                ...
                var cacheKey = string.Format(QNetModelCacheDefaults.CategoryHasFeaturedProductsKey, category.Id,
        ...
        {
            var templateCacheKey = string.Format(QNetModelCacheDefaults.CategoryTemplateModelKey, templateId);
        ...
        public virtual TopMenuModel PrepareTopMenuModel()
        {
            ...
            //top menu topics
            var topicCacheKey = string.Format(QNetModelCacheDefaults.TopicTopMenuModelKey,
                _workContext.WorkingLanguage.Id,
                _storeContext.CurrentStore.Id,
                string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()));
        ...
        public virtual List<CategoryModel> PrepareHomepageCategoryModels()
        {
            ...
            var categoriesCacheKey = string.Format(QNetModelCacheDefaults.CategoryHomepageKey,
                string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
                pictureSize,
                _storeContext.CurrentStore.Id,
                _workContext.WorkingLanguage.Id,
            ...
            var model = _cacheManager.Get(categoriesCacheKey, () =>
                ...
                .Select(category =>
                {
                    ...
                    //prepare picture model
                    var categoryPictureCacheKey = string.Format(QNetModelCacheDefaults.CategoryPictureModelKey, category.Id, pictureSize, true, _workContext.WorkingLanguage.Id, _webHelper.IsCurrentConnectionSecured(), _storeContext.CurrentStore.Id);
        ...
        {
            //load and cache them
            var cacheKey = string.Format(QNetModelCacheDefaults.CategoryAllModelKey,
                _workContext.WorkingLanguage.Id,
                string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
                _storeContext.CurrentStore.Id);
        ...
        public virtual List<CategorySimpleModel> PrepareCategorySimpleModels(int rootCategoryId, bool loadSubCategories = true)
        {
            ...
            foreach (var category in categories)
            {
                ...
                {
                    var cacheKey = string.Format(QNetModelCacheDefaults.CategoryNumberOfProductsModelKey,
                        string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
                        _storeContext.CurrentStore.Id,
                        category.Id);
        ...
        {
            var cacheKey = string.Format(QNetModelCacheDefaults.CategoryXmlAllModelKey,
                _workContext.WorkingLanguage.Id,
                string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
                _storeContext.CurrentStore.Id);
        ...
        public virtual ManufacturerModel PrepareManufacturerModel(Manufacturer manufacturer, CatalogPagingFilteringModel command)
        {
            ...
            if (!_catalogSettings.IgnoreFeaturedProducts)
            {
                ...
                //We cache a value indicating whether we have featured products
                var cacheKey = string.Format(QNetModelCacheDefaults.ManufacturerHasFeaturedProductsKey,
                    manufacturer.Id,
                    string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
                    _storeContext.CurrentStore.Id);
                var hasFeaturedProductsCache = _cacheManager.Get(cacheKey, () =>
        ...
        {
            var templateCacheKey = string.Format(QNetModelCacheDefaults.ManufacturerTemplateModelKey, templateId);
            var templateViewPath = _cacheManager.Get(templateCacheKey, () =>
            {
        ...
        public virtual List<ManufacturerModel> PrepareManufacturerAllModels()
        {
            ...
            foreach (var manufacturer in manufacturers)
            {
                ...
                var manufacturerPictureCacheKey = string.Format(QNetModelCacheDefaults.ManufacturerPictureModelKey, manufacturer.Id, pictureSize, true, _workContext.WorkingLanguage.Id, _webHelper.IsCurrentConnectionSecured(), _storeContext.CurrentStore.Id);
        ...
        {
            var cacheKey = string.Format(QNetModelCacheDefaults.ManufacturerNavigationModelKey,
        ...
        public virtual List<VendorModel> PrepareVendorAllModels()
        {
            ...
            foreach (var vendor in vendors)
            {
                ...
                var pictureCacheKey = string.Format(QNetModelCacheDefaults.VendorPictureModelKey, vendor.Id, pictureSize, true, _workContext.WorkingLanguage.Id, _webHelper.IsCurrentConnectionSecured(), _storeContext.CurrentStore.Id);
        ...
        {
            var cacheKey = QNetModelCacheDefaults.VendorNavigationModelKey;
            var cachedModel = _cacheManager.Get(cacheKey, () =>
            {
        ...
        {
            var cacheKey = string.Format(QNetModelCacheDefaults.ProductTagPopularModelKey, _workContext.WorkingLanguage.Id, _storeContext.CurrentStore.Id);
            var cachedModel = _cacheManager.Get(cacheKey, () =>
            {
        ...
        public virtual SearchModel PrepareSearchModel(SearchModel model, CatalogPagingFilteringModel command)
        {
            ...
            var cacheKey = string.Format(QNetModelCacheDefaults.SearchCategoriesModelKey,
                _workContext.WorkingLanguage.Id,
                string.Join(",", _workContext.CurrentCustomer.GetCustomerRoleIds()),
                _storeContext.CurrentStore.Id);
