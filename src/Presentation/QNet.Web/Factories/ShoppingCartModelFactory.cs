...
namespace QNet.Web.Factories
{
    ...
    public partial class ShoppingCartModelFactory : IShoppingCartModelFactory
    {
        ...
        protected virtual ShoppingCartModel.OrderReviewDataModel PrepareOrderReviewDataModel(IList<ShoppingCartItem> cart)
        {
            ...
            if (_shoppingCartService.ShoppingCartRequiresShipping(cart))
            {
                ...
                var pickupPoint = _genericAttributeService.GetAttribute<PickupPoint>(_workContext.CurrentCustomer,
                    QNetCustomerDefaults.SelectedPickupPointAttribute, _storeContext.CurrentStore.Id);
                ...
                var shippingOption = _genericAttributeService.GetAttribute<ShippingOption>(_workContext.CurrentCustomer,
                    QNetCustomerDefaults.SelectedShippingOptionAttribute, _storeContext.CurrentStore.Id);
                if (shippingOption != null)
                    model.ShippingMethod = shippingOption.Name;
            }

            //payment info
            var selectedPaymentMethodSystemName = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer, QNetCustomerDefaults.SelectedPaymentMethodAttribute, _storeContext.CurrentStore.Id);
        ...
        {
            var pictureCacheKey = string.Format(QNetModelCacheDefaults.CartPictureModelKey, sci.Id, pictureSize, true, _workContext.WorkingLanguage.Id, _webHelper.IsCurrentConnectionSecured(), _storeContext.CurrentStore.Id);
        ...
        public virtual MiniShoppingCartModel PrepareMiniShoppingCartModel()
        {
            ...
            if (_workContext.CurrentCustomer.HasShoppingCartItems)
            {
                ...
                if (cart.Any())
                {
                    ...
                    var checkoutAttributesExistCacheKey = string.Format(QNetModelCacheDefaults.CheckoutAttributesExistKey,
        ...
        public virtual OrderTotalsModel PrepareOrderTotalsModel(IList<ShoppingCartItem> cart, bool isEditable)
        {
            ...
            if (cart.Any())
            {
                ...
                //payment method fee
                var paymentMethodSystemName = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer, QNetCustomerDefaults.SelectedPaymentMethodAttribute, _storeContext.CurrentStore.Id);
