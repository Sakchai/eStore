    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        public virtual IActionResult Index()
        {
            ...
            var checkoutAttributesXml = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer,
                QNetCustomerDefaults.CheckoutAttributes, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult SelectBillingAddress(int addressId, bool shipToSameAddress = false)
        {
            ...
            if (_shippingSettings.ShipToSameAddress && shipToSameAddress && _shoppingCartService.ShoppingCartRequiresShipping(cart) && shippingAllowed)
            {
                ...
                _genericAttributeService.SaveAttribute<ShippingOption>(_workContext.CurrentCustomer, QNetCustomerDefaults.SelectedShippingOptionAttribute, null, _storeContext.CurrentStore.Id);
                _genericAttributeService.SaveAttribute<PickupPoint>(_workContext.CurrentCustomer, QNetCustomerDefaults.SelectedPickupPointAttribute, null, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult NewShippingAddress(CheckoutShippingAddressModel model, IFormCollection form)
        {
            ...
            if (_shippingSettings.AllowPickupInStore)
            {
                if (model.PickupInStore)
                {
                    ...
                    _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, QNetCustomerDefaults.SelectedShippingOptionAttribute, pickUpInStoreShippingOption, _storeContext.CurrentStore.Id);
                    _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, QNetCustomerDefaults.SelectedPickupPointAttribute, selectedPoint, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult ShippingMethod()
        {
                ...
                model.ShippingMethods.Count == 1)
            {
                ...
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                    QNetCustomerDefaults.SelectedShippingOptionAttribute,
        ...
        public virtual IActionResult SelectShippingMethod(string shippingoption)
        {
            ...
            if (!_shoppingCartService.ShoppingCartRequiresShipping(cart))
            {
                _genericAttributeService.SaveAttribute<ShippingOption>(_workContext.CurrentCustomer,
                    QNetCustomerDefaults.SelectedShippingOptionAttribute, null, _storeContext.CurrentStore.Id);
                return RedirectToRoute("CheckoutPaymentMethod");
            }
            ...
            var shippingOptions = _genericAttributeService.GetAttribute<List<ShippingOption>>(_workContext.CurrentCustomer,
                QNetCustomerDefaults.OfferedShippingOptionsAttribute, _storeContext.CurrentStore.Id);
            ...
            //save
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, QNetCustomerDefaults.SelectedShippingOptionAttribute, shippingOption, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult PaymentMethod()
        {
            ...
            if (!isPaymentWorkflowRequired)
            {
                _genericAttributeService.SaveAttribute<string>(_workContext.CurrentCustomer,
                    QNetCustomerDefaults.SelectedPaymentMethodAttribute, null, _storeContext.CurrentStore.Id);
                ...
                paymentMethodModel.PaymentMethods.Count == 1 && !paymentMethodModel.DisplayRewardPoints)
            {
                ...
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                    QNetCustomerDefaults.SelectedPaymentMethodAttribute,
        ...
        public virtual IActionResult SelectPaymentMethod(string paymentmethod, CheckoutPaymentMethodModel model)
        {
            ...
            {
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                    QNetCustomerDefaults.UseRewardPointsDuringCheckoutAttribute, model.UseRewardPoints,
                    _storeContext.CurrentStore.Id);
            }
            ...
            //save
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                QNetCustomerDefaults.SelectedPaymentMethodAttribute, paymentmethod, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult PaymentInfo()
        {
            ...
            var paymentMethodSystemName = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer,
                QNetCustomerDefaults.SelectedPaymentMethodAttribute, _storeContext.CurrentStore.Id);
