...
using QNet.Services.ExportImport;
...
namespace QNet.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        protected virtual string ParseCustomCustomerAttributes(IFormCollection form)
        {
            ...
            {
                var controlId = $"{QNetAttributePrefixDefaults.Customer}{attribute.Id}";
        ...
        public virtual IActionResult Logout()
        {
            if (_workContext.OriginalCustomerIfImpersonated != null)
            {
                ...
                _genericAttributeService
                    .SaveAttribute<int?>(_workContext.OriginalCustomerIfImpersonated, QNetCustomerDefaults.ImpersonatedCustomerIdAttribute, null);
            ...
            if (_storeInformationSettings.DisplayEuCookieLawWarning)
            {
                ...
                TempData[$"{QNetCookieDefaults.Prefix}{QNetCookieDefaults.IgnoreEuCookieLawWarning}"] = true; 
            }
        ...
        public virtual IActionResult PasswordRecoverySend(PasswordRecoveryModel model, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (customer != null && customer.Active && !customer.Deleted)
                {
                    ...
                    _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.PasswordRecoveryTokenAttribute,
                        passwordRecoveryToken.ToString());
                    DateTime? generatedDateTime = DateTime.UtcNow;
                    _genericAttributeService.SaveAttribute(customer,
                        QNetCustomerDefaults.PasswordRecoveryTokenDateGeneratedAttribute, generatedDateTime);
        ...
        public virtual IActionResult PasswordRecoveryConfirm(string token, string email, Guid guid)
        {
            ...
            if (customer == null)
                customer = _customerService.GetCustomerByGuid(guid.ToString());

            if (customer == null)
                return RedirectToRoute("Homepage");

            if (string.IsNullOrEmpty(_genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.PasswordRecoveryTokenAttribute)))
            {
        ...
        public virtual IActionResult Register(RegisterModel model, string returnUrl, bool captchaValid, IFormCollection form)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (registrationResult.Success)
                {
                    ...
                    {
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.TimeZoneIdAttribute, model.TimeZoneId);
                    }
                    //VAT number
                    if (_taxSettings.EuVatEnabled)
                    {
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.VatNumberAttribute, model.VatNumber);

                        var vatNumberStatus = _taxService.GetVatNumberStatus(model.VatNumber, out _, out var vatAddress);
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.VatNumberStatusIdAttribute, (int)vatNumberStatus);
                    ...
                    if (_customerSettings.GenderEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.GenderAttribute, model.Gender);
                    _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.FirstNameAttribute, model.FirstName);
                    _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.LastNameAttribute, model.LastName);
                    if (_customerSettings.DateOfBirthEnabled)
                    {
                        var dateOfBirth = model.ParseDateOfBirth();
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.DateOfBirthAttribute, dateOfBirth);
                    }
                    if (_customerSettings.CompanyEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.CompanyAttribute, model.Company);
                    if (_customerSettings.StreetAddressEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.StreetAddressAttribute, model.StreetAddress);
                    if (_customerSettings.StreetAddress2Enabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.StreetAddress2Attribute, model.StreetAddress2);
                    if (_customerSettings.ZipPostalCodeEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.ZipPostalCodeAttribute, model.ZipPostalCode);
                    if (_customerSettings.CityEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.CityAttribute, model.City);
                    if (_customerSettings.CountyEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.CountyAttribute, model.County);
                    if (_customerSettings.CountryEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.CountryIdAttribute, model.CountryId);
                    if (_customerSettings.CountryEnabled && _customerSettings.StateProvinceEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.StateProvinceIdAttribute,
                            model.StateProvinceId);
                    if (_customerSettings.PhoneEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.PhoneAttribute, model.Phone);
                    if (_customerSettings.FaxEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.FaxAttribute, model.Fax);
                    ...
                    _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.CustomCustomerAttributes, customerAttributesXml);
                    ...
                    {
                        FirstName = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.FirstNameAttribute),
                        LastName = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.LastNameAttribute),
                        Email = customer.Email,
                        Company = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.CompanyAttribute),
                        CountryId = _genericAttributeService.GetAttribute<int>(customer, QNetCustomerDefaults.CountryIdAttribute) > 0
                            ? (int?)_genericAttributeService.GetAttribute<int>(customer, QNetCustomerDefaults.CountryIdAttribute)
                            : null,
                        StateProvinceId = _genericAttributeService.GetAttribute<int>(customer, QNetCustomerDefaults.StateProvinceIdAttribute) > 0
                            ? (int?)_genericAttributeService.GetAttribute<int>(customer, QNetCustomerDefaults.StateProvinceIdAttribute)
                            : null,
                        County = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.CountyAttribute),
                        City = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.CityAttribute),
                        Address1 = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.StreetAddressAttribute),
                        Address2 = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.StreetAddress2Attribute),
                        ZipPostalCode = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.ZipPostalCodeAttribute),
                        PhoneNumber = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.PhoneAttribute),
                        FaxNumber = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.FaxAttribute),
                        ...
                        case UserRegistrationType.EmailValidation:
                            {
                                ...
                                _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.AccountActivationTokenAttribute, Guid.NewGuid().ToString());
        ...
        public virtual IActionResult AccountActivation(string token, string email, Guid guid)
        {
            ...
            var cToken = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.AccountActivationTokenAttribute);
            ...
            _customerService.UpdateCustomer(customer);
            _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.AccountActivationTokenAttribute, "");
        ...
        public virtual IActionResult Info(CustomerInfoModel model, IFormCollection form)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (_dateTimeSettings.AllowCustomersToSetTimeZone)
                    {
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.TimeZoneIdAttribute,
                            model.TimeZoneId);
                    }
                    //VAT number
                    if (_taxSettings.EuVatEnabled)
                    {
                        var prevVatNumber = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.VatNumberAttribute);

                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.VatNumberAttribute,
                            model.VatNumber);
                    ...
                    if (_customerSettings.CountryEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.CountryIdAttribute, model.CountryId);
                    if (_customerSettings.CountryEnabled && _customerSettings.StateProvinceEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.StateProvinceIdAttribute, model.StateProvinceId);
                    if (_customerSettings.PhoneEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.PhoneAttribute, model.Phone);
                    if (_customerSettings.FaxEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.FaxAttribute, model.Fax);
                    ...
                    if (_forumSettings.ForumsEnabled && _forumSettings.SignaturesEnabled)
                        _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.SignatureAttribute, model.Signature);

                    //save customer attributes
                    _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                        QNetCustomerDefaults.CustomCustomerAttributes, customerAttributesXml);
        ...
        public virtual IActionResult EmailRevalidation(string token, string email, Guid guid)
        {
            ...
            var cToken = _genericAttributeService.GetAttribute<string>(customer, QNetCustomerDefaults.EmailRevalidationTokenAttribute);
            if (string.IsNullOrEmpty(cToken))
            ...
            _customerService.UpdateCustomer(customer);
            _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.EmailRevalidationTokenAttribute, "");
        ...
        public virtual IActionResult UploadAvatar(CustomerAvatarModel model, IFormFile uploadedFile)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    var customerAvatar = _pictureService.GetPictureById(_genericAttributeService.GetAttribute<int>(customer, QNetCustomerDefaults.AvatarPictureIdAttribute));
                    if (uploadedFile != null && !string.IsNullOrEmpty(uploadedFile.FileName))
                    {
                        var avatarMaxSize = _customerSettings.AvatarMaximumSizeBytes;
                        if (uploadedFile.Length > avatarMaxSize)
                            throw new QNetException(string.Format(_localizationService.GetResource("Account.Avatar.MaximumUploadedFileSize"), avatarMaxSize));
                    ...
                    _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.AvatarPictureIdAttribute, customerAvatarId);

                    model.AvatarUrl = _pictureService.GetPictureUrl(
                        _genericAttributeService.GetAttribute<int>(customer, QNetCustomerDefaults.AvatarPictureIdAttribute),
        ...
        public virtual IActionResult RemoveAvatar(CustomerAvatarModel model)
        {
            ...
            _genericAttributeService.SaveAttribute(customer, QNetCustomerDefaults.AvatarPictureIdAttribute, 0);
