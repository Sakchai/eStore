...
namespace QNet.Web.Framework.TagHelpers.Shared
{
    /// <summary>
    ...
    public class QNetDatePickerTagHelper : TagHelper
    {
        ...
        public QNetDatePickerTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
