...
namespace QNet.Web.Framework.TagHelpers.Admin
{
    ...
    public class QNetLabelTagHelper : TagHelper
    {
        ...
        public QNetLabelTagHelper(IHtmlGenerator generator, IWorkContext workContext, ILocalizationService localizationService)
        {
            Generator = generator;
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (tagBuilder != null)
            {
                ...
                //add hint
                if (For.Metadata.AdditionalValues.TryGetValue("QNetResourceDisplayNameAttribute", out object value))
                {
                    var resourceDisplayName = value as QNetResourceDisplayNameAttribute;
