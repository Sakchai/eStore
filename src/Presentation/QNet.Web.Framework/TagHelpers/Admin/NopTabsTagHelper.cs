...
namespace QNet.Web.Framework.TagHelpers.Admin
{
    ...
    public class QNetTabsTagHelper : TagHelper
    {
        ...
        public QNetTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<QNetTabContextItem>();
            context.Items.Add(typeof(QNetTabsTagHelper), tabContext);
    ...
    public class QNetTabTagHelper : TagHelper
    {
        ...
        /// </summary>
        /// <param name="htmlHelper">HTML helper</param>
        public QNetTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<QNetTabContextItem>)context.Items[typeof(QNetTabsTagHelper)];
            tabContext.Add(new QNetTabContextItem()
            {
    ...
    /// Tab context item
    /// </summary>
    public class QNetTabContextItem
    {
        /// <summary>
        /// Title
        /// </summary>
