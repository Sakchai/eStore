...
namespace QNet.Web.Framework.Seo
{
    /// <summary>
    ...
    public class GenericPathRoute : LocalizedRoute
    {
        ...
        public override Task RouteAsync(RouteContext context)
        {
            ...
            if (!urlRecord.IsActive)
            {
                ...
                redirectionRouteData.Values[QNetPathRouteDefaults.ControllerFieldKey] = "Common";
                redirectionRouteData.Values[QNetPathRouteDefaults.ActionFieldKey] = "InternalRedirect";
                redirectionRouteData.Values[QNetPathRouteDefaults.UrlFieldKey] = $"{pathBase}/{activeSlug}{context.HttpContext.Request.QueryString}";
                redirectionRouteData.Values[QNetPathRouteDefaults.PermanentRedirectFieldKey] = true;
            ...
            if (!string.IsNullOrEmpty(slugForCurrentLanguage) && !slugForCurrentLanguage.Equals(slug, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                redirectionRouteData.Values[QNetPathRouteDefaults.ControllerFieldKey] = "Common";
                redirectionRouteData.Values[QNetPathRouteDefaults.ActionFieldKey] = "InternalRedirect";
                redirectionRouteData.Values[QNetPathRouteDefaults.UrlFieldKey] = $"{pathBase}/{slugForCurrentLanguage}{context.HttpContext.Request.QueryString}";
                redirectionRouteData.Values[QNetPathRouteDefaults.PermanentRedirectFieldKey] = false;
                context.HttpContext.Items["nop.RedirectFromGenericPathRoute"] = true;
                context.RouteData = redirectionRouteData;
                return _target.RouteAsync(context);
            }
            ...
            {
                case "product":
                    currentRouteData.Values[QNetPathRouteDefaults.ControllerFieldKey] = "Product";
                    currentRouteData.Values[QNetPathRouteDefaults.ActionFieldKey] = "ProductDetails";
                    currentRouteData.Values[QNetPathRouteDefaults.ProductIdFieldKey] = urlRecord.EntityId;
                    currentRouteData.Values[QNetPathRouteDefaults.SeNameFieldKey] = urlRecord.Slug;
                    break;
                case "producttag":
                    currentRouteData.Values[QNetPathRouteDefaults.ControllerFieldKey] = "Catalog";
                    currentRouteData.Values[QNetPathRouteDefaults.ActionFieldKey] = "ProductsByTag";
                    currentRouteData.Values[QNetPathRouteDefaults.ProducttagIdFieldKey] = urlRecord.EntityId;
                    currentRouteData.Values[QNetPathRouteDefaults.SeNameFieldKey] = urlRecord.Slug;
                    break;
                case "category":
                    currentRouteData.Values[QNetPathRouteDefaults.ControllerFieldKey] = "Catalog";
                    currentRouteData.Values[QNetPathRouteDefaults.ActionFieldKey] = "Category";
                    currentRouteData.Values[QNetPathRouteDefaults.CategoryIdFieldKey] = urlRecord.EntityId;
                    currentRouteData.Values[QNetPathRouteDefaults.SeNameFieldKey] = urlRecord.Slug;
                    break;
                case "manufacturer":
                    currentRouteData.Values[QNetPathRouteDefaults.ControllerFieldKey] = "Catalog";
                    currentRouteData.Values[QNetPathRouteDefaults.ActionFieldKey] = "Manufacturer";
                    currentRouteData.Values[QNetPathRouteDefaults.ManufacturerIdFieldKey] = urlRecord.EntityId;
                    currentRouteData.Values[QNetPathRouteDefaults.SeNameFieldKey] = urlRecord.Slug;
                    break;
                case "vendor":
                    currentRouteData.Values[QNetPathRouteDefaults.ControllerFieldKey] = "Catalog";
                    currentRouteData.Values[QNetPathRouteDefaults.ActionFieldKey] = "Vendor";
                    currentRouteData.Values[QNetPathRouteDefaults.VendorIdFieldKey] = urlRecord.EntityId;
                    currentRouteData.Values[QNetPathRouteDefaults.SeNameFieldKey] = urlRecord.Slug;
                    break;
                case "newsitem":
                    currentRouteData.Values[QNetPathRouteDefaults.ControllerFieldKey] = "News";
                    currentRouteData.Values[QNetPathRouteDefaults.ActionFieldKey] = "NewsItem";
                    currentRouteData.Values[QNetPathRouteDefaults.NewsItemIdFieldKey] = urlRecord.EntityId;
                    currentRouteData.Values[QNetPathRouteDefaults.SeNameFieldKey] = urlRecord.Slug;
                    break;
                case "blogpost":
                    currentRouteData.Values[QNetPathRouteDefaults.ControllerFieldKey] = "Blog";
                    currentRouteData.Values[QNetPathRouteDefaults.ActionFieldKey] = "BlogPost";
                    currentRouteData.Values[QNetPathRouteDefaults.BlogPostIdFieldKey] = urlRecord.EntityId;
                    currentRouteData.Values[QNetPathRouteDefaults.SeNameFieldKey] = urlRecord.Slug;
                    break;
                case "topic":
                    currentRouteData.Values[QNetPathRouteDefaults.ControllerFieldKey] = "Topic";
                    currentRouteData.Values[QNetPathRouteDefaults.ActionFieldKey] = "TopicDetails";
                    currentRouteData.Values[QNetPathRouteDefaults.TopicIdFieldKey] = urlRecord.EntityId;
                    currentRouteData.Values[QNetPathRouteDefaults.SeNameFieldKey] = urlRecord.Slug;
                    break;
                default:
