...
namespace QNet.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        {
            var cookieName = $"{QNetCookieDefaults.Prefix}{QNetCookieDefaults.CustomerCookie}";
        ...
        public virtual Customer CurrentCustomer
        {
            get
            {
                ...
                if (_httpContextAccessor.HttpContext == null ||
                    _httpContextAccessor.HttpContext.Request.Path.Equals(new PathString($"/{QNetTaskDefaults.ScheduleTaskPath}"), StringComparison.InvariantCultureIgnoreCase))
                {
                    //in this case return built-in customer record for background task
                    customer = _customerService.GetCustomerBySystemName(QNetCustomerDefaults.BackgroundTaskCustomerName);
                }
                ...
                if (customer == null || customer.Deleted || !customer.Active || customer.RequireReLogin)
                {
                    ...
                    if (_userAgentHelper.IsSearchEngine())
                        customer = _customerService.GetCustomerBySystemName(QNetCustomerDefaults.SearchEngineCustomerName);
                }
                ...
                if (customer != null && !customer.Deleted && customer.Active && !customer.RequireReLogin)
                {
                    ...
                    var impersonatedCustomerId = _genericAttributeService
                        .GetAttribute<int?>(customer, QNetCustomerDefaults.ImpersonatedCustomerIdAttribute);
                ...
                if (customer == null || customer.Deleted || !customer.Active || customer.RequireReLogin)
                {
                    ...
                    if (!string.IsNullOrEmpty(customerCookie))
                    {
                        if (Guid.TryParse(customerCookie, out Guid customerGuid))
                        {
                            ...
                            var customerByCookie = _customerService.GetCustomerByGuid(customerGuid.ToString());
        ...
        public virtual Language WorkingLanguage
        {
            get
            {
                ...
                if (detectedLanguage == null && _localizationSettings.AutomaticallyDetectLanguage)
                {
                    ...
                    var alreadyDetected = _genericAttributeService.GetAttribute<bool>(CurrentCustomer,
                        QNetCustomerDefaults.LanguageAutomaticallyDetectedAttribute, _storeContext.CurrentStore.Id);
                    ...
                    if (!alreadyDetected)
                    {
                        ...
                        if (detectedLanguage != null)
                        {
                            ...
                            _genericAttributeService.SaveAttribute(CurrentCustomer,
                                QNetCustomerDefaults.LanguageAutomaticallyDetectedAttribute, true, _storeContext.CurrentStore.Id);
                        }
                    }
                }
                ...
                if (detectedLanguage != null)
                {
                    ...
                    var currentLanguageId = _genericAttributeService.GetAttribute<int>(CurrentCustomer,
                        QNetCustomerDefaults.LanguageIdAttribute, _storeContext.CurrentStore.Id);

                    //save the detected language identifier if it differs from the current one
                    if (detectedLanguage.Id != currentLanguageId)
                    {
                        _genericAttributeService.SaveAttribute(CurrentCustomer,
                            QNetCustomerDefaults.LanguageIdAttribute, detectedLanguage.Id, _storeContext.CurrentStore.Id);
                    }
                }
            ...
            set
            {
                ...
                //and save it
                _genericAttributeService.SaveAttribute(CurrentCustomer,
                    QNetCustomerDefaults.LanguageIdAttribute, languageId, _storeContext.CurrentStore.Id);
        ...
        public virtual Currency WorkingCurrency
        {
            get
            {
                ...
                var customerCurrencyId = _genericAttributeService.GetAttribute<int>(CurrentCustomer,
                    QNetCustomerDefaults.CurrencyIdAttribute, _storeContext.CurrentStore.Id);
            ...
            set
            {
                ...
                //and save it
                _genericAttributeService.SaveAttribute(CurrentCustomer,
                    QNetCustomerDefaults.CurrencyIdAttribute, currencyId, _storeContext.CurrentStore.Id);
        ...
        public virtual TaxDisplayType TaxDisplayType
        {
            get
            {
                ...
                if (_taxSettings.AllowCustomersToSelectTaxDisplayType && CurrentCustomer != null)
                {
                    ...
                    var taxDisplayTypeId = _genericAttributeService.GetAttribute<int?>(CurrentCustomer,
                        QNetCustomerDefaults.TaxDisplayTypeIdAttribute, _storeContext.CurrentStore.Id);
            ...
            set
            {
                ...
                //save passed value
                _genericAttributeService.SaveAttribute(CurrentCustomer,
                    QNetCustomerDefaults.TaxDisplayTypeIdAttribute, (int)value, _storeContext.CurrentStore.Id);
