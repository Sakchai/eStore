...
namespace QNet.Web.Framework.Security
{
    /// <summary>
    ...
    public static class FilePermissionHelper
    {
        ...
        public static IEnumerable<string> GetFilesWrite()
        {
            ...
            {
                fileProvider.MapPath(QNetPluginDefaults.PluginsInfoFilePath),
                fileProvider.MapPath(QNetDataSettingsDefaults.FilePath)
            };
        }
