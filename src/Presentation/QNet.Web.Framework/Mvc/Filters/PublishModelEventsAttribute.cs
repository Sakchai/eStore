    ...
    public class PublishModelEventsAttribute : TypeFilterAttribute
    {
        ...
        private class PublishModelEventsFilter : IActionFilter
        {
            ...
            public void OnActionExecuting(ActionExecutingContext context)
            {
                ...
                foreach (var model in context.ActionArguments.Values.OfType<BaseQNetModel>())
                {
                    //we publish the ModelReceived event for all models as the BaseQNetModel, 
                    //so you need to implement IConsumer<ModelReceived<BaseQNetModel>> interface to handle this event
            ...
            public void OnActionExecuted(ActionExecutedContext context)
            {
                ...
                {
                    if (controller.ViewData.Model is BaseQNetModel model)
                    {
                    ...
                    if (controller.ViewData.Model is IEnumerable<BaseQNetModel> modelCollection)
                    {
