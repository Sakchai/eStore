...
namespace QNet.Web.Framework.Mvc.Routing
{
    /// <summary>
    /// Represents custom overridden redirect result executor
    /// </summary>
    public class QNetRedirectResultExecutor : RedirectResultExecutor
    {
        #region Fields
        ...
        public QNetRedirectResultExecutor(ILoggerFactory loggerFactory, 
