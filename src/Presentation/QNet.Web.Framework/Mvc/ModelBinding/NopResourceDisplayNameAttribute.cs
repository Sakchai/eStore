...
namespace QNet.Web.Framework.Mvc.ModelBinding
{
    ...
    /// </summary>
    public class QNetResourceDisplayNameAttribute : DisplayNameAttribute, IModelAttribute
    {
        #region Fields
        ...
        public QNetResourceDisplayNameAttribute(string resourceKey) : base(resourceKey)
        {
        ...
        public string Name
        {
            get { return nameof(QNetResourceDisplayNameAttribute); }
        }
