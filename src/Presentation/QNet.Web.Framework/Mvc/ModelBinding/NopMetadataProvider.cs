...
namespace QNet.Web.Framework.Mvc.ModelBinding
{
    ...
    /// </summary>
    public class QNetMetadataProvider : IDisplayMetadataProvider
    {
        /// <summary>
        ...
        public void CreateDisplayMetadata(DisplayMetadataProviderContext context)
        {
            ...
            foreach (var additionalValue in additionalValues)
            {
                if (context.DisplayMetadata.AdditionalValues.ContainsKey(additionalValue.Name))
                    throw new QNetException("There is already an attribute with the name '{0}' on this model", additionalValue.Name);
